...
class SuperAdminSiteContentController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        $textRules = [
            ...
            'whatsapp_message_plan_basico' => ['nullable', 'string', 'max:500'],
            'whatsapp_message_plan_profesional' => ['nullable', 'string', 'max:500'],
            'whatsapp_message_plan_premium' => ['nullable', 'string', 'max:500'],
            'whatsapp_message_plan_sucursales' => ['nullable', 'string', 'max:500'],
            ...
            'section_1_cta_label' => ['nullable', 'string', 'max:80'],
            'section_1_cta_url' => ['nullable', 'string', 'max:500'],
            'section_1_modal_button_label' => ['nullable', 'string', 'max:80'],
            'section_1_modal_badge' => ['nullable', 'string', 'max:120'],
            'section_1_modal_title' => ['nullable', 'string', 'max:255'],
            'section_1_modal_text' => ['nullable', 'string', 'max:1200'],
            'section_1_modal_item_1' => ['nullable', 'string', 'max:220'],
            'section_1_modal_item_2' => ['nullable', 'string', 'max:220'],
            'section_1_modal_item_3' => ['nullable', 'string', 'max:220'],
            ...
            'section_2_cta_label' => ['nullable', 'string', 'max:80'],
            'section_2_cta_url' => ['nullable', 'string', 'max:500'],
            'section_2_modal_button_label' => ['nullable', 'string', 'max:80'],
            'section_2_modal_badge' => ['nullable', 'string', 'max:120'],
            'section_2_modal_title' => ['nullable', 'string', 'max:255'],
            'section_2_modal_text' => ['nullable', 'string', 'max:1200'],
            'section_2_modal_item_1' => ['nullable', 'string', 'max:220'],
            'section_2_modal_item_2' => ['nullable', 'string', 'max:220'],
            'section_2_modal_item_3' => ['nullable', 'string', 'max:220'],
            ...
            'section_3_cta_label' => ['nullable', 'string', 'max:80'],
            'section_3_cta_url' => ['nullable', 'string', 'max:500'],
            'section_3_modal_button_label' => ['nullable', 'string', 'max:80'],
            'section_3_modal_badge' => ['nullable', 'string', 'max:120'],
            'section_3_modal_title' => ['nullable', 'string', 'max:255'],
            'section_3_modal_text' => ['nullable', 'string', 'max:1200'],
            'section_3_modal_item_1' => ['nullable', 'string', 'max:220'],
            'section_3_modal_item_2' => ['nullable', 'string', 'max:220'],
            'section_3_modal_item_3' => ['nullable', 'string', 'max:220'],
        ...
        $imageFieldToSetting = [
            ...
            'section_1_modal_image_file' => 'section_1_modal_image_path',
            'section_1_modal_secondary_image_file' => 'section_1_modal_secondary_image_path',
            'section_2_image_file' => 'section_2_image_path',
            'section_2_modal_image_file' => 'section_2_modal_image_path',
            'section_2_modal_secondary_image_file' => 'section_2_modal_secondary_image_path',
            'section_3_image_file' => 'section_3_image_path',
            'section_3_modal_image_file' => 'section_3_modal_image_path',
            'section_3_modal_secondary_image_file' => 'section_3_modal_secondary_image_path',
        ];
