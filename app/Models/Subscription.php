...
class Subscription extends Model
{
    ...
    protected $fillable = [
        ...
        'plan_name',
        'price',
        'sucursales_intro_pending',
        'sucursales_base_price',
        'sucursales_intro_discount_percent',
        'starts_at',
        'ends_at',
        'status',
        'last_payment_method',
    ...
    protected function casts(): array
    {
        return [
            ...
            'price' => 'decimal:2',
            'sucursales_intro_pending' => 'boolean',
            'sucursales_base_price' => 'decimal:2',
            'sucursales_intro_discount_percent' => 'integer',
            'starts_at' => 'date',
            'ends_at' => 'date',
            'grace_days' => 'integer',
        ];
