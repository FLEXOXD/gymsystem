...
class DemoSessionService
{
    ...
    public function guideSteps(string $gymSlug): array
    {
        ...
        return [
            [
                'title' => 'Menu lateral',
                'text' => 'Usa este boton para abrir/cerrar el menu del sistema.',
                'route' => $panelRoute,
            ...
            [
                ...
                'text' => 'Desde aqui ves indicadores del dia y estado operativo del gimnasio.',
                'route' => $panelRoute,
                'selector' => '#tour-panel-summary',
                'placement' => 'bottom',
            ],
            [
                'title' => 'Acceso rapido a clientes',
                'text' => 'Este acceso te lleva directo al modulo de clientes para registrar o editar datos.',
                'route' => $panelRoute,
            ...
            [
                ...
                'text' => 'Crea un cliente y, si quieres, inicia su membresia en el mismo flujo.',
                'route' => $clientsRoute,
            ...
            [
                ...
                'text' => 'Filtra por nombre, apellido o documento para ubicar rapido al cliente.',
                'route' => $clientsRoute,
            ...
            [
                ...
                'text' => 'Aqui controlas estado, vencimiento, pago y accion rapida por cliente.',
                'route' => $clientsRoute,
            ...
            [
                ...
                'text' => 'Elige si el plan se calcula por dias exactos o meses calendario.',
                'route' => $plansRoute,
            ...
            [
                ...
                'text' => 'Guarda el plan para que quede disponible en ventas de membresias.',
                'route' => $plansRoute,
            ...
            [
                ...
                'text' => 'Haz cuadre por metodo y cierra turno con control de diferencias.',
                'route' => $cashRoute,
            ...
            [
                ...
                'text' => 'Consulta turnos anteriores y auditoria de caja.',
                'route' => $cashRoute,
            ...
            [
                ...
                'text' => 'Selecciona rango de fechas para analizar operacion y finanzas.',
                'route' => $reportsRoute,
            ...
            [
                ...
                'text' => 'Genera reporte PDF para compartir con administracion o dueños.',
                'route' => $reportsRoute,
            ...
            [
                ...
                'text' => 'Entra al detalle de ingresos para revisar movimientos por metodo.',
                'route' => $reportsRoute,
                'selector' => '#reports-go-income',
                'placement' => 'top',
            ],
            [
                'title' => 'Configuracion: selector de tema',
            ...
            [
                'title' => 'Configuracion: datos del gym',
                'text' => 'Edita nombre, telefono, moneda e idioma de operacion.',
                'route' => $settingsRoute,
                'selector' => '#gym-profile-form',
                'placement' => 'left',
            ],
            [
                'title' => 'Configuracion: zona horaria',
            ...
            [
                'title' => 'Configuracion: avatares fallback',
                'text' => 'Sube avatares por genero cuando un cliente no tenga foto.',
                'route' => $settingsRoute,
