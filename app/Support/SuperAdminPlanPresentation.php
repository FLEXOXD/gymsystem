    ...
    public static function metadata(): array
    {
        return [
            ...
            'profesional' => [
                ...
                'summary' => 'Suma reportes, promociones, PWA y ventas de productos para trabajar con más control.',
                'features' => [
                    ...
                    'PWA instalable en celular, tableta y escritorio',
            ...
            'premium' => [
                'title' => 'Plan premium',
                'summary' => 'Te da una operación más completa, con mejor experiencia para clientes y más control comercial.',
                'features' => [
                    ...
                    'Incluido: cuentas de cliente con usuario y contraseña para la aplicación móvil PWA',
                    'Incluido: registro de asistencia desde la aplicación móvil PWA con QR dinámico temporal',
                ],
            ...
            'sucursales' => [
                ...
                'features' => [
                    ...
                    'Módulo de sucursales y enlaces entre sede principal y sucursal',
                    ...
                    'Incluido: cuentas de cliente con usuario y contraseña para la aplicación móvil PWA por sede',
                    'Incluido: registro de asistencia desde la aplicación móvil PWA con QR dinámico temporal por sucursal',
                ],
