<?php if (! $__env->hasRenderedOnce('befc1d66-411c-4a87-8b36-f0f5e8644b42')): $__env->markAsRenderedOnce('befc1d66-411c-4a87-8b36-f0f5e8644b42'); ?>
    <style>
...
<section id="classes-view" class="space-y-4">
    ...
    <article class="glass-card rounded-3xl p-4 space-y-3">
        ...
        <?php if($todayGymClasses->isNotEmpty()): ?>
            <div class="gym-classes-scroll <?php echo e($todayGymClasses->count() > 1 ? 'is-scrollable' : ''); ?>">
                <?php $__currentLoopData = $todayGymClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php else: ?>
            <div class="rounded-3xl border border-dashed border-white/15 bg-white/5 px-4 py-6 text-center">
                ...
                <p class="mt-1 text-xs text-slate-300">Revisa el calendario para encontrar otra fecha disponible.</p>
            </div>
        <?php endif; ?>
    </article>
...
<?php if (! $__env->hasRenderedOnce('fc753c5c-1f1e-461f-b96f-ea50beda5ae5')): $__env->markAsRenderedOnce('fc753c5c-1f1e-461f-b96f-ea50beda5ae5'); ?>
    <script>
        (function () {
            const closeModal = (modal) => {
                ...
                if (!document.querySelector('.classes-day-modal:not(.hidden)')) {
                    document.body.classList.remove('gym-classes-modal-open');
                }
            };
            ...
            const openModal = (modalId) => {
                ...
                document.body.classList.add('gym-classes-modal-open');
            };
            ...
            document.addEventListener('click', (event) => {
                ...
                if (openTrigger) {
                    ...
                    openModal(openTrigger.getAttribute('data-classes-modal-open'));
                    return;
                }
                ...
                if (closeTrigger) {
                    event.preventDefault();
                    closeModal(closeTrigger.closest('.classes-day-modal'));
                }
            });
