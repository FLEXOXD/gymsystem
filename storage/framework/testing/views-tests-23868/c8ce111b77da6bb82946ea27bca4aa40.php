...
<head>
    ...
    <style>
        ...
        .theme-light #panel-sidebar {
            background:
                linear-gradient(180deg, rgb(246 249 252 / 0.98) 0%, rgb(239 244 248 / 0.96) 100%);
            box-shadow: inset -1px 0 0 rgb(15 23 42 / 0.04);
        }
        #brand-home-link {
            padding-top: 1rem;
            padding-bottom: 1rem;
        ...
        .sidebar-nav-item {
            ...
            transition: border-color 160ms ease, background-color 160ms ease, box-shadow 180ms ease, color 160ms ease;
        }
        ...
        .theme-light .sidebar-nav-item.theme-nav-active {
            box-shadow: 0 14px 22px -20px rgb(15 23 42 / 0.16);
        }
        .sidebar-nav-item .sidebar-icon {
        ...
        .theme-light header.theme-header {
            background:
                linear-gradient(180deg, rgb(255 255 255 / 0.95) 0%, rgb(248 250 252 / 0.92) 100%);
            box-shadow: 0 10px 26px -24px rgb(15 23 42 / 0.12);
        }
        #panel-header-shell {
            padding-top: 0.82rem;
