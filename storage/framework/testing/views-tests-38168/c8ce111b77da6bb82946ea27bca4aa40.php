                        ...
                        <div id="user-menu-dropdown" class="absolute right-0 z-40 mt-2 hidden w-64 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-slate-700 dark:bg-slate-900">
                            ...
                            <div class="p-2">
                                <?php if(! $isCashierMode): ?>
                                    ...
                                    <?php if($showFloatingButtonsMenu): ?>
                                        ...
                                        <div id="user-menu-floating-actions-panel"
                                            ...
                                            <div class="mt-3 grid gap-2">
                                                <?php if($showFloatingClientSetting): ?>
                                                    <label class="flex items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white/85 px-3 py-2.5 dark:border-slate-700 dark:bg-slate-900/70">
                                                ...
                                                <?php if($showFloatingSaleSetting): ?>
                                                    <label class="flex items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white/85 px-3 py-2.5 dark:border-slate-700 dark:bg-slate-900/70">
                                                        <span class="inline-flex min-w-0 items-center gap-2">
...
<?php echo $__env->make('layouts.partials.panel.quick-actions', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
