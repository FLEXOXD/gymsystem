...
<div id="<?php echo e($widgetDomId); ?>"
     class="gs-support-chat-root"
     data-compact-launcher="<?php echo e($compactLauncher ? '1' : '0'); ?>"
     data-context-type="<?php echo e($isGymPanelContext ? 'gym_panel' : 'landing'); ?>"
     data-context="<?php echo e($contextKey); ?>"
     data-state-url="<?php echo e($stateUrl); ?>"
     data-restart-url="<?php echo e($restartUrl); ?>"
     data-quick-url="<?php echo e($quickReplyUrl); ?>"
     data-message-url="<?php echo e($messageUrl); ?>"
     data-csrf-token="<?php echo e($csrfToken !== '' ? $csrfToken : csrf_token()); ?>"
     data-poll-seconds="<?php echo e($pollSeconds); ?>"
     data-lead-capture="<?php echo e($leadCapture ? '1' : '0'); ?>"
     data-initial-quick='<?php echo json_encode($quickReplies, 15, 512) ?>'
     data-welcome-message="<?php echo e($welcomeMessage); ?>"
     data-assistant-name="<?php echo e($assistantName); ?>"
     data-assistant-subtitle="<?php echo e($assistantSubtitle); ?>"
     style="--gs-chat-bottom: <?php echo e($desktopBottomOffsetPx); ?>px; --gs-chat-bottom-mobile: <?php echo e($mobileBottomOffsetPx); ?>px;">
    <button type="button" class="gs-support-chat-launcher" aria-label="<?php echo e($launcherTitle); ?>" data-chat-launcher>
        ...
        <span class="gs-support-chat-launcher__label"><?php echo e($launcherTitle); ?></span>
    </button>
    ...
    <section class="gs-support-chat-panel" hidden data-chat-panel>
        <header class="gs-support-chat-header">
            <div class="gs-support-chat-header__identity">
                <div class="gs-support-chat-header__avatar">
                    <?php if(trim((string) $gymLogoUrl) !== ''): ?>
                        <img src="<?php echo e($gymLogoUrl); ?>" alt="<?php echo e(trim((string) $gymName) !== '' ? $gymName : $assistantName); ?>">
                    <?php else: ?>
                        <svg viewBox="0 0 24 24" fill="none">
                            <circle cx="12" cy="8" r="3.4" stroke="currentColor" stroke-width="1.8"></circle>
                            <path d="M5 18.5c0-3 3.2-5 7-5s7 2 7 5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
                ...
                <div>
                    <p class="gs-support-chat-header__name"><?php echo e($assistantName); ?></p>
                    <p class="gs-support-chat-header__meta"><?php echo e($assistantSubtitle); ?></p>
        ...
        <div class="gs-support-chat-body">
            ...
            <p class="gs-support-chat-helper" data-chat-helper><?php echo e($welcomeMessage); ?></p>
        </div>
...
<script>
    (function () {
        const root = document.getElementById(<?php echo json_encode($widgetDomId, 15, 512) ?>);
        if (!root) return;
...
<?php /**PATH C:\laragon\www\gymsystem\resources\views/components/support-chat/widget.blade.php ENDPATH**/ ?>