    ...
    <div class="ui-modal-shell max-w-5xl" x-transition.scale.origin.top>
        <form method="POST"
            ...
            <header class="flex items-start justify-between border-b border-slate-800 px-6 py-4">
                <div>
                    <h3 class="text-xl font-black text-slate-100">Ajustar membresía</h3>
                    ...
                    <div class="space-y-5">
                        <div class="grid gap-4 md:grid-cols-2">
                            ...
                            <label class="space-y-1 text-sm font-semibold text-slate-300">
                                ...
                                <select name="adjustment_type" class="ui-input" x-model="adjustmentForm.type" x-ref="adjustmentTypeInput">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <label class="space-y-1 text-sm font-semibold text-slate-300 md:col-span-2">
                                ...
                                <select name="reason" class="ui-input" x-model="adjustmentForm.reason">
                                    <?php $__currentLoopData = $adjustmentReasonLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value); ?>"><?php echo e($label); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <label class="space-y-1 text-sm font-semibold text-slate-300">
                            ...
                            <textarea name="notes"
                                      ...
                                      placeholder="Detalle breve del acuerdo o corrección aplicada."></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <aside class="space-y-4 rounded-2xl border border-slate-700 bg-slate-950/70 p-4">
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wider text-slate-500">Membresía seleccionada</p>
                            <p class="mt-2 text-lg font-black text-slate-100" x-text="selectedAdjustmentMembership() ? selectedAdjustmentMembership().planName : 'Sin selección'"></p>
                        ...
                        <div class="rounded-xl border border-slate-800 bg-slate-900/70 p-4 text-xs text-slate-400">
                            <p class="font-semibold text-slate-300">Guía rápida</p>
                            <p class="mt-2">`Reprogramar inicio` recalcula el fin con la duración del plan actual.</p>
                            <p class="mt-1">`Extender acceso` solo suma días al final existente.</p>
                            <p class="mt-1">`Definir ventana manual` te deja fijar inicio y fin explícitos.</p>
                        </div>
                    </aside>
                </div>
            </div>
