...
<?php endif; ?>
        ...
        <?php if($premiumClientsDashboard): ?>
            <?php
                $premiumClientAlerts = collect($premiumClientsDashboard['alerts'] ?? [])->values();
                $premiumClientMetrics = [
                    [
                        'label' => 'Clientes con app',
                        'value' => (string) ((int) ($premiumClientsDashboard['clients_with_app_access_count'] ?? 0)),
                        'note' => (string) ((int) ($premiumClientsDashboard['active_clients_with_app_access_count'] ?? 0)).' activos ya pueden usar portal.',
                        'tone' => 'success',
                    ],
                    [
                    ...
                    [
                        ...
                        'note' => 'Por vencer y vencidos listos para cierre.',
                        'tone' => 'accent',
                    ],
                    [
                        'label' => 'Asistieron hoy',
                        'value' => (string) ((int) ($premiumClientsDashboard['attended_today_count'] ?? 0)),
                        'note' => 'Movimiento real dentro del plan premium.',
                        'tone' => 'info',
                    ],
                ];
            ?>
                ...
                <div class="clients-pro-grid">
                    <div class="flex flex-wrap items-start justify-between gap-3">
                        <div class="clients-pro-copy">
                            ...
                            <h2 class="clients-pro-heading"><?php echo e($premiumClientsDashboard['headline'] ?? 'Base premium lista para acceso cliente y renovacion'); ?></h2>
                            <p class="clients-pro-summary"><?php echo e($premiumClientsDashboard['summary'] ?? 'Cruza usuarios app, renovaciones y actividad real dentro de una sola franja premium.'); ?></p>
                        </div>
                    ...
                    <?php if($premiumClientAlerts->isNotEmpty()): ?>
                        <div class="clients-pro-insights">
...
<?php unset($__componentOriginala8bb031a483a05f647cb99ed3a469847); ?>
<?php endif; ?>
                        <?php elseif($canUseSalesInventory): ?>
                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('sales.index', $clientsRouteParams),'variant' => 'ghost']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
...
<?php $component->withAttributes(['title' => 'Clientes del gimnasio','subtitle' => ''.e($planControlClientsDashboard ? 'Base ordenada para recepcion, renovaciones y seguimiento diario.' : 'Vista operacional para recepcion, renovaciones y retencion.').'','class' => 'clients-main-card']); ?>
            <div class="clients-toolbar-shell space-y-4">
                <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    <form method="GET" action="<?php echo e(route('clients.index')); ?>" class="clients-search-form grid gap-3 lg:grid-cols-[1fr_auto_auto] lg:w-full lg:max-w-3xl">
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('clients.index'),'variant' => 'ghost','class' => 'clients-toolbar-button']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('clients.index')),'variant' => 'ghost','class' => 'clients-toolbar-button']); ?>Limpiar <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
