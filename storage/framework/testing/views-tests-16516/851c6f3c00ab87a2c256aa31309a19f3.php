            ...
            <table class="ui-table min-w-[1100px]">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr class="border-b border-slate-100 text-sm odd:bg-white even:bg-slate-50 dark:border-slate-800 dark:odd:bg-slate-900 dark:even:bg-slate-950/50">
                        <td class="px-3 py-3 dark:text-slate-200"><?php echo e($notification->scheduled_for?->toDateString()); ?></td>
                        <td class="px-3 py-3 font-semibold dark:text-slate-100"><?php echo e($notification->gym?->name ?? 'N/D'); ?></td>
                        <td class="px-3 py-3 dark:text-slate-200"><?php echo e($typeLabel); ?></td>
                        <td class="px-3 py-3">
                            <?php
                            ...
                            ?>
                            <span class="inline-flex rounded-full px-2.5 py-1 text-xs font-bold uppercase tracking-wide <?php echo e($statusClass); ?>">
                        ...
                        <td class="px-3 py-3 dark:text-slate-200"><?php echo e($notification->createdBy?->name ?? '-'); ?></td>
                        <td class="px-3 py-3 dark:text-slate-200"><?php echo e($notification->sent_at?->format('Y-m-d H:i') ?? '-'); ?></td>
                    </tr>
