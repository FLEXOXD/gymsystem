                        ...
                        <tr class="border-b border-slate-100 align-top text-sm odd:bg-white even:bg-slate-50 dark:border-slate-800 dark:odd:bg-slate-900 dark:even:bg-slate-950/50">
                            ...
                            <td class="px-3 py-3 dark:text-slate-200">
                                ...
                                <?php if(is_string($receiptUrl) && $receiptUrl !== ''): ?>
                                    <a href="<?php echo e($receiptUrl); ?>" target="_blank" rel="noopener" class="mt-2 inline-flex rounded-full bg-cyan-100 px-2.5 py-1 text-xs font-semibold text-cyan-800 hover:bg-cyan-200 dark:bg-cyan-900/45 dark:text-cyan-200 dark:hover:bg-cyan-900/65">
                                        Ver comprobante
                                    </a>
                                <?php endif; ?>
                            </td>
                            <td class="px-3 py-3">
                                ...
                                <?php if(! $isPending && $suggestion->reviewedBy): ?>
                                    <p class="mt-1 text-xs ui-muted">Por <?php echo e($suggestion->reviewedBy->name); ?></p>
                                <?php endif; ?>
                            </td>
                            <td class="px-3 py-3">
                                <?php if($isPending): ?>
