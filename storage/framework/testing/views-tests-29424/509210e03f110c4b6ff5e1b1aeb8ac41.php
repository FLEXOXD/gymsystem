...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'result-panel','class' => 'relative overflow-hidden border-slate-300 bg-white dark:border-slate-700 dark:bg-slate-900','title' => 'Resultado']); ?>
        ...
        <div class="overflow-x-auto">
            <table class="ui-table min-w-[780px]">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentAttendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <tr data-role="recent-attendance-row" data-attendance-id="<?php echo e((int) $attendance->id); ?>" class="border-b border-slate-100 text-sm odd:bg-white even:bg-slate-50 dark:border-slate-800 dark:odd:bg-slate-900 dark:even:bg-slate-950/50">
