...
<?php if($schemaReady && $remoteScannerReady && ! $isGlobalScope): ?>
        ...
        <div class="remote-scan-modal__card">
            <div class="remote-scan-modal__header">
                <div>
                    ...
                    <h2 class="mt-3 text-2xl font-black"><?php echo e($fabTitle); ?></h2>
                    <p class="mt-2 max-w-2xl text-sm text-slate-300"><?php echo e($fabSubtitle); ?></p>
                </div>
                ...
                <div class="remote-scan-modal__panel">
                    ...
                    <div class="remote-scan-modal__meta">
                        ...
                        <article class="is-wide">
                            ...
                            <p id="remote-scan-rotation-note" class="remote-scan-modal__last"><?php echo e($rotationMessage); ?></p>
                        </article>
                        <article class="is-wide">
    ...
    <script>
        (function () {
            ...
            const createUrl = <?php echo json_encode(route('remote-scanner.sessions.store', ['contextGym' => $contextGym]), 512) ?>;
            const scanContext = <?php echo json_encode($scanContext, 15, 512) ?>;
            ...
            function resetUi() {
                ...
                mobileUrlEl.value = '';
                if (rotationNoteEl) {
                    rotationNoteEl.textContent = <?php echo json_encode($rotationMessage, 15, 512) ?>;
                }
            ...
            function applySession(payload) {
                ...
                if (rotationNoteEl) {
                    rotationNoteEl.textContent = payload.rotation_note || <?php echo json_encode($rotationMessage, 15, 512) ?>;
                }
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\gymsystem\resources\views/sales_inventory/partials/remote-scanner-fab.blade.php ENDPATH**/ ?>