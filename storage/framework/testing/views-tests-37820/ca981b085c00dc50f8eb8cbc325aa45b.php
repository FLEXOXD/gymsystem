<?php $__env->startSection('title', 'Bandeja de contacto web'); ?>
<?php $__env->startSection('page-title', 'Inbox de contacto y soporte'); ?>
    ...
    <div class="sa-shell">
            ...
            <div class="sa-hero-grid">
                ...
                <aside class="sa-note-card">
                    ...
                    <div class="sa-note-list">
                        ...
                        <div class="sa-note-item">
                            <strong><?php echo e($supportRepresentativeOnline ? $supportRepresentativeName.' conectado' : 'Sin representante activo'); ?></strong>
        ...
        <section class="sa-stat-grid">
            ...
            <article class="sa-stat-card is-warning">
                ...
                <p class="sa-stat-meta"><?php echo e($reviewedCount); ?> revisados en la bandeja web.</p>
            </article>
            <article class="sa-stat-card is-info">
                <p class="sa-stat-label">Chats soporte</p>
                <p class="sa-stat-value"><?php echo e($supportTotalCount); ?></p>
            ...
            <article class="sa-stat-card is-success">
                ...
                <p class="sa-stat-value"><?php echo e($supportUnreadCount); ?></p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Bandeja de contacto web','subtitle' => 'Mensajes del formulario público. Campaña: 4 horas. Inbox y borrado: 24 horas.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Bandeja de contacto web','subtitle' => 'Mensajes del formulario público. Campaña: 4 horas. Inbox y borrado: 24 horas.']); ?>
        <?php if($unreadCount > 0): ?>
            <div class="mb-4 rounded-xl border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-900 dark:border-amber-500/30 dark:bg-amber-900/20 dark:text-amber-100">
                <p class="font-bold">Tienes <?php echo e($unreadCount); ?> mensaje(s) sin revisar.</p>
                <p class="mt-1">
                    Si no los abres, se eliminan automáticamente a las 24 horas.
                    <?php if($nextUnreadMinutesLeft !== null): ?>
                        El próximo vence en <strong><?php echo e($nextUnreadMinutesLeft); ?> min</strong>.
                    <?php endif; ?>
                </p>
            </div>
        <?php endif; ?>
        ...
        <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
            <div class="flex flex-wrap items-center gap-2 text-xs font-semibold uppercase tracking-wide">
                ...
                <span class="inline-flex items-center rounded-full bg-emerald-100 px-2.5 py-1 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-200">
                    Sin leer: <?php echo e($unreadCount); ?>

                </span>
            </div>

            <form method="GET" action="<?php echo e(route('superadmin.inbox.index')); ?>" class="grid w-full gap-2 sm:w-auto sm:grid-cols-[150px_260px_auto]">
                <select name="status" class="ui-input">
                    <option value="all" <?php if($filters['status'] === 'all'): echo 'selected'; endif; ?>>Todos</option>
                    <option value="unread" <?php if($filters['status'] === 'unread'): echo 'selected'; endif; ?>>Sin leer</option>
                    <option value="read" <?php if($filters['status'] === 'read'): echo 'selected'; endif; ?>>Leídos</option>
                </select>
                <input type="text" name="q" value="<?php echo e($filters['q']); ?>" class="ui-input" placeholder="Buscar por nombre, correo o texto">
            ...
            <aside class="overflow-hidden rounded-xl border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900">
                <div class="max-h-[68vh] overflow-y-auto">
                    <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <a href="<?php echo e(route('superadmin.inbox.show', array_merge(['message' => $message->id], request()->only(['status', 'q', 'page'])))); ?>"
                           class="block border-b border-slate-100 px-4 py-3 transition last:border-b-0 hover:bg-slate-50 dark:border-slate-800 dark:hover:bg-slate-800/40 <?php echo e($isActive ? 'bg-slate-100 dark:bg-slate-800/70' : ''); ?>">
                            ...
                            <p class="mt-0.5 text-xs text-slate-500 dark:text-slate-300"><?php echo e($message->email); ?></p>
                            <p class="mt-1 text-xs text-slate-600 dark:text-slate-300"><?php echo e(\Illuminate\Support\Str::limit($message->message, 90)); ?></p>
                            <div class="mt-1 flex items-center justify-between gap-2">
                                <p class="text-[11px] font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-500">
                                    <?php echo e($message->created_at?->copy()->timezone($panelTimezone)?->format('d/m/Y H:i')); ?>

                                </p>
                                <?php if($minutesLeft !== null): ?>
                                    <span class="inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide <?php echo e($minutesLeft <= 20 ? 'bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-200' : 'bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-200'); ?>">
                                        Vence en <?php echo e($minutesLeft); ?> min
                                    </span>
                                <?php endif; ?>
                            </div>
                        </a>
                ...
                <?php if($selectedMessage): ?>
                    ...
                    <div class="flex flex-wrap items-start justify-between gap-3 border-b border-slate-200 pb-3 dark:border-slate-700">
                        <div>
                            ...
                            <p class="text-sm text-slate-600 dark:text-slate-300"><?php echo e($selectedMessage->email); ?></p>
                            <p class="mt-1 text-xs font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-500">
                                Recibido: <?php echo e($selectedMessage->created_at?->copy()->timezone($panelTimezone)?->format('d/m/Y H:i')); ?>

                            </p>
                            <?php if($selectedMinutesLeft !== null): ?>
                                <p class="mt-1 inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide <?php echo e($selectedMinutesLeft <= 20 ? 'bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-200' : 'bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-200'); ?>">
                                    Se elimina en <?php echo e($selectedMinutesLeft); ?> min
                                </p>
                            <?php endif; ?>
                        </div>
                        <?php if($selectedMessage->read_at === null): ?>
                            <form method="POST" action="<?php echo e(route('superadmin.inbox.read', $selectedMessage->id)); ?>">
                                <?php echo csrf_field(); ?>
                                <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','size' => 'sm','variant' => 'secondary']); ?>Marcar como leído <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                    ...
                    <article class="mt-4 whitespace-pre-wrap break-words rounded-xl bg-slate-50 p-4 text-sm leading-relaxed text-slate-800 dark:bg-slate-800/50 dark:text-slate-100">
                        <?php echo e($selectedMessage->message); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['id' => 'support-chat-inbox','title' => 'Bandeja de chat de soporte','subtitle' => 'Conversaciones del botón flotante (página principal y panel de gimnasios).','class' => 'mt-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'support-chat-inbox','title' => 'Bandeja de chat de soporte','subtitle' => 'Conversaciones del botón flotante (página principal y panel de gimnasios).','class' => 'mt-6']); ?>
        <?php if(! ($supportSchemaReady ?? false)): ?>
            <div class="mb-4 rounded-xl border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-900 dark:border-amber-500/30 dark:bg-amber-900/20 dark:text-amber-100">
        ...
        <?php elseif(($supportLoadError ?? false) === true && $supportConversations->count() === 0): ?>
        ...
        <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
            <div class="flex flex-wrap items-center gap-2 text-xs font-semibold uppercase tracking-wide">
                <span class="inline-flex items-center rounded-full bg-slate-200 px-2.5 py-1 text-slate-700 dark:bg-slate-800 dark:text-slate-200">
                    Total: <?php echo e($supportTotalCount); ?>

                </span>
                <span class="inline-flex items-center rounded-full bg-emerald-100 px-2.5 py-1 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-200">
                    Sin leer: <?php echo e($supportUnreadCount); ?>

                </span>
                <span class="inline-flex items-center rounded-full px-2.5 py-1 <?php echo e($supportRepresentativeOnline ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/40 dark:text-emerald-200' : 'bg-slate-200 text-slate-700 dark:bg-slate-800 dark:text-slate-200'); ?>">
                    <?php echo e($supportRepresentativeOnline ? ($supportRepresentativeName.' conectado') : 'Representante no conectado'); ?>

                </span>
            </div>

            <form method="GET" action="<?php echo e(route('superadmin.inbox.index')); ?>" class="grid w-full gap-2 sm:w-auto sm:grid-cols-[180px_260px_auto]">
                ...
                <select name="support_status" class="ui-input">
                    <option value="all" <?php if(($supportFilters['status'] ?? 'all') === 'all'): echo 'selected'; endif; ?>>Todos</option>
                    <option value="unread" <?php if(($supportFilters['status'] ?? '') === 'unread'): echo 'selected'; endif; ?>>Sin leer</option>
                    <option value="bot" <?php if(($supportFilters['status'] ?? '') === 'bot'): echo 'selected'; endif; ?>>Bot</option>
                    <option value="waiting_agent" <?php if(($supportFilters['status'] ?? '') === 'waiting_agent'): echo 'selected'; endif; ?>>Esperando agente</option>
                    <option value="active" <?php if(($supportFilters['status'] ?? '') === 'active'): echo 'selected'; endif; ?>>Activos</option>
                    <option value="closed" <?php if(($supportFilters['status'] ?? '') === 'closed'): echo 'selected'; endif; ?>>Cerrados</option>
                </select>
                <input type="text" name="support_q" value="<?php echo e($supportFilters['q'] ?? ''); ?>" class="ui-input" placeholder="Buscar por gimnasio o contacto">
                <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','variant' => 'secondary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
...
<?php endif; ?>
        ...
        <?php if(($supportUnreadCount ?? 0) > 0 && ($supportTotalCount ?? 0) === 0): ?>
        ...
        <div class="support-chat-grid grid gap-4 xl:grid-cols-[360px_minmax(0,1fr)]">
            <aside class="support-chat-sidebar overflow-hidden rounded-xl border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900">
                <div class="support-chat-list-scroll max-h-[70vh] overflow-y-auto">
                    <?php $__empty_1 = true; $__currentLoopData = $supportConversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <a href="<?php echo e(route('superadmin.inbox.index', $supportLinkQuery)); ?>"
                           class="support-chat-list-item block border-b border-slate-100 px-4 py-3 transition last:border-b-0 hover:bg-slate-50 dark:border-slate-800 dark:hover:bg-slate-800/40 <?php echo e($conversationActive ? 'is-active bg-slate-100 dark:bg-slate-800/70' : ''); ?>">
                            <div class="flex items-start gap-3">
                                <div class="h-10 w-10 shrink-0 overflow-hidden rounded-full border border-slate-200 bg-slate-100 dark:border-slate-700 dark:bg-slate-800">
                                    <?php if($logoUrl): ?>
                                        <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($displayName); ?>" class="h-full w-full object-cover">
                                    <?php else: ?>
                                        <span class="flex h-full w-full items-center justify-center text-xs font-black text-slate-700 dark:text-slate-200"><?php echo e($displayInitials); ?></span>
                                    <?php endif; ?>
                                </div>
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-start justify-between gap-2">
                                        <p class="truncate text-sm font-bold text-slate-900 dark:text-slate-100"><?php echo e($displayName); ?></p>
                                        <?php if($unreadSupport > 0): ?>
                                            <span class="inline-flex min-w-[1.4rem] items-center justify-center rounded-full bg-emerald-500 px-1.5 py-0.5 text-[10px] font-black text-white"><?php echo e($unreadSupport); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <p class="mt-0.5 text-xs text-slate-500 dark:text-slate-300"><?php echo e($conversation->sourceLabel()); ?> - <?php echo e($conversation->requesterLabel()); ?></p>
                                    <p class="mt-1 line-clamp-2 text-xs text-slate-600 dark:text-slate-300"><?php echo e(\Illuminate\Support\Str::limit((string) ($conversation->latestMessage?->message ?? 'Sin mensajes'), 110)); ?></p>
                                    <div class="mt-1 flex items-center justify-between gap-2">
                                        <span class="inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide <?php echo e($statusClass); ?>">
                                            <?php echo e($conversation->statusLabel()); ?>

                                        </span>
                                        <span class="text-[11px] font-semibold uppercase tracking-wide text-slate-400 dark:text-slate-500">
                                            <?php echo e($conversation->last_message_at?->copy()->timezone($panelTimezone)?->format('d/m/Y H:i')); ?>
            ...
            <section class="support-chat-detail rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900"
                     <?php if($selectedSupportConversation): ?>
                         data-support-detail
                         data-support-state-url="<?php echo e(route('superadmin.support-chat.state', $selectedSupportConversation->id)); ?>"
                     <?php endif; ?>>
                <?php if($selectedSupportConversation): ?>
                    <?php
                    ...
                    <div class="support-chat-detail__header flex flex-wrap items-start justify-between gap-3 border-b border-slate-200 pb-3 dark:border-slate-700">
                        <div>
                            <h3 class="text-lg font-black text-slate-900 dark:text-slate-100" data-support-title><?php echo e($selectedSupportConversation->displayName()); ?></h3>
                            <p class="text-sm text-slate-600 dark:text-slate-300" data-support-source-label>
                                <?php echo e($selectedSupportConversation->sourceLabel()); ?> - <?php echo e($selectedSupportConversation->requesterLabel()); ?>

                            </p>
                            <?php if(trim((string) $selectedSupportConversation->visitor_email) !== ''): ?>
                                <p class="text-xs text-slate-500 dark:text-slate-400" data-support-email><?php echo e($selectedSupportConversation->visitor_email); ?></p>
                            <?php endif; ?>
                            <?php if(trim((string) $selectedSupportConversation->visitor_name) !== ''): ?>
                                <p class="text-xs text-slate-500 dark:text-slate-400" data-support-contact-name>Contacto: <?php echo e($selectedSupportConversation->visitor_name); ?></p>
                            <?php endif; ?>
                        </div>
                        <span data-support-status-badge
                              data-support-status="<?php echo e($selectedSupportConversation->status); ?>"
                              class="support-status-badge inline-flex items-center rounded-full px-2.5 py-1 text-xs font-bold uppercase tracking-wide <?php echo e($selectedSupportStatusClass); ?>">
                            <?php echo e($selectedSupportConversation->statusLabel()); ?>
                    ...
                    <div data-support-thread class="support-chat-thread mt-4 max-h-[46vh] space-y-3 overflow-y-auto rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800/40">
                        <?php $__empty_1 = true; $__currentLoopData = $selectedSupportMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chatMessage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            ?>
                            <div class="support-thread-row <?php echo e($isMine ? 'is-mine' : ''); ?>">
                                <article class="support-thread-bubble <?php echo e($isSystem ? 'is-system' : ($isMine ? 'is-mine' : 'is-other')); ?>">
                                    <p class="support-thread-bubble__label"><?php echo e($senderLabel); ?></p>
                                    <p class="support-thread-bubble__text"><?php echo e($chatMessage->message); ?></p>
                                    <p class="support-thread-bubble__time">
                                        <?php echo e($chatMessage->created_at?->copy()->timezone($panelTimezone)?->format('d/m/Y H:i')); ?>
                    ...
                    <div class="support-chat-controls mt-4 grid gap-3 lg:grid-cols-[minmax(0,1fr)_220px]">
                        <form method="POST"
                              action="<?php echo e(route('superadmin.support-chat.reply', $selectedSupportConversation->id)); ?>"
                              class="space-y-2"
                            ...
                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','variant' => 'secondary','dataSupportReplySubmit' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'secondary','data-support-reply-submit' => true]); ?>Enviar respuesta <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                        ...
                        <div class="space-y-2">
                            <form method="POST"
                                  action="<?php echo e(route('superadmin.support-chat.status', $selectedSupportConversation->id)); ?>"
                                  class="space-y-2"
                                ...
                                <label class="text-xs font-bold uppercase tracking-wide text-slate-500 dark:text-slate-400">
                                    ...
                                    <select name="status" class="ui-input mt-1" data-support-status-select>
                                        <option value="bot" <?php if($selectedSupportConversation->status === 'bot'): echo 'selected'; endif; ?>>Bot</option>
                                        <option value="waiting_agent" <?php if($selectedSupportConversation->status === 'waiting_agent'): echo 'selected'; endif; ?>>Esperando agente</option>
                                        <option value="active" <?php if($selectedSupportConversation->status === 'active'): echo 'selected'; endif; ?>>Activa</option>
                                        <option value="closed" <?php if($selectedSupportConversation->status === 'closed'): echo 'selected'; endif; ?>>Cerrada</option>
                                    </select>
                                </label>
                                <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','variant' => 'ghost','dataSupportStatusSubmit' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'ghost','data-support-status-submit' => true]); ?>Actualizar estado <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                            ...
                            <form method="POST"
                                  action="<?php echo e(route('superadmin.support-chat.finalize', $selectedSupportConversation->id)); ?>"
                                  data-support-finalize-form>
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="status" value="<?php echo e($filters['status']); ?>">
                                <input type="hidden" name="q" value="<?php echo e($filters['q']); ?>">
                                <input type="hidden" name="support" value="<?php echo e($selectedSupportConversation->id); ?>">
                                <input type="hidden" name="support_status" value="<?php echo e($supportFilters['status'] ?? 'all'); ?>">
                                <input type="hidden" name="support_q" value="<?php echo e($supportFilters['q'] ?? ''); ?>">
                                <input type="hidden" name="support_page" value="<?php echo e(request()->query('support_page', 1)); ?>">
                                <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','variant' => 'danger','dataSupportFinalizeSubmit' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'danger','data-support-finalize-submit' => true]); ?>Finalizar conversacion <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
        ...
        <div class="mt-4">
            <?php echo e($supportConversations->links()); ?>
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\gymsystem\resources\views/superadmin/inbox/index.blade.php ENDPATH**/ ?>