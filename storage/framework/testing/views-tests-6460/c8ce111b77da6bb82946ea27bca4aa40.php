...
<head>
    ...
    <style>
        ...
        .ui-loading-overlay {
            ...
            padding: 1.25rem;
            background:
                radial-gradient(circle at center, rgb(217 255 67 / 0.1) 0%, rgb(217 255 67 / 0.05) 12%, rgb(0 0 0 / 0.42) 34%, rgb(0 0 0 / 0.9) 100%),
                linear-gradient(180deg, rgb(3 5 8 / 0.8), rgb(0 0 0 / 0.95));
            backdrop-filter: blur(18px) saturate(0.84) brightness(0.76);
        }
        ...
        .ui-loading-card::before {
            ...
            border-radius: 999px;
            background:
                radial-gradient(circle, rgb(0 0 0 / 0.96) 0%, rgb(5 7 6 / 0.9) 40%, rgb(217 255 67 / 0.11) 68%, transparent 86%);
            filter: blur(32px);
        }
        .ui-loading-spin {
            position: relative;
            ...
            box-shadow:
                ...
                0 0 16px rgb(217 255 67 / 0.24),
                0 0 30px rgb(217 255 67 / 0.16),
                0 14px 36px rgb(0 0 0 / 0.28);
        }
        .ui-loading-spin::before {
            ...
            border-top-color: rgb(217 255 67 / 0.82);
        ...
        .ui-loading-message {
            ...
            color: #ffffff;
            text-shadow:
                0 0 1px rgb(255 255 255 / 0.12),
                0 0 14px rgb(217 255 67 / 0.14),
                0 2px 14px rgb(0 0 0 / 0.72);
