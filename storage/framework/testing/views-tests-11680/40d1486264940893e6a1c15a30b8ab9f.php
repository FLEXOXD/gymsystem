            ...
            <?php if($isCashierScoped): ?>
                <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <article class="rounded-xl border border-cyan-200 bg-cyan-50 p-3 dark:border-cyan-400/40 dark:bg-cyan-500/15">
                        ...
                        <p class="mt-1 text-xl font-black text-cyan-800 dark:text-cyan-100"><?php echo e($currencyFormatter::format((float) ($panelSessionSummary['net_total'] ?? 0), $appCurrencyCode)); ?></p>
                        <p class="text-xs text-cyan-700 dark:text-cyan-200"><?php echo e((int) ($panelSessionSummary['movements_count'] ?? 0)); ?> movimientos propios</p>
                    </article>
                </div>
            <?php else: ?>
                <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
