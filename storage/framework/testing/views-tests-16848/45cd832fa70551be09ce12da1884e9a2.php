...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Contenido comercial','subtitle' => 'Editor visual de landing para editar por secciones y ver la vista previa al instante.','class' => 'sa-form-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Contenido comercial','subtitle' => 'Editor visual de landing para editar por secciones y ver la vista previa al instante.','class' => 'sa-form-card']); ?>
                <form id="site-content-form" method="POST" action="<?php echo e(route('superadmin.web-page.update')); ?>" enctype="multipart/form-data" class="sa-form-workbench sa-editor-workbench site-content-editor grid gap-4 text-slate-800 lg:grid-cols-2" aria-describedby="site-content-form-help">
                    <?php echo csrf_field(); ?>
