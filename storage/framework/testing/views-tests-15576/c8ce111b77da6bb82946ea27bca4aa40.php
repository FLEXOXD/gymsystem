        ...
        <nav class="space-y-1 px-3 py-4">
            <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e(route($item['route'], $item['params'] ?? [])); ?>"
                   ...
                   class="flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-semibold transition <?php echo e($isActive ? 'theme-nav-active' : 'theme-nav-link'); ?>">
                    <span class="theme-nav-dot inline-flex h-2.5 w-2.5 rounded-full <?php echo e($isActive ? 'bg-white' : ''); ?>"></span>
                    ...
                    <?php if($headerLiveClientsVisible): ?>
                        ...
                        <?php else: ?>
                            <span id="header-live-banner"
                                  class="inline-flex items-center gap-2 rounded-full border border-emerald-400/45 bg-emerald-500/15 px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-emerald-200 shadow-[0_0_0_1px_rgba(16,185,129,0.2)]"
                                ...
                                <span>PRESENTES</span>
                                <strong id="header-live-clients" class="text-base leading-none text-emerald-50"><?php echo e((int) $headerLiveClientsCount); ?></strong>
                                <span class="tracking-[0.04em]">ahora</span>
                            </span>
                        <?php endif; ?>
                    <?php endif; ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $headerContactItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bellMessage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <a href="<?php echo e(route('superadmin.inbox.show', $bellMessage->id)); ?>"
                                           class="header-bell-item <?php echo e($bellUnread ? 'is-unread' : ''); ?>">
                                            ...
                                            <p class="header-bell-time"><?php echo e($bellMessage->created_at?->format('d/m/Y H:i')); ?></p>
                                        </a>
        ...
        async function refreshLiveClients() {
            ...
            try {
                ...
                if (payload && Object.prototype.hasOwnProperty.call(payload, 'count')) {
                    ...
                    headerLiveClients.textContent = String(Number.isFinite(nextCount) ? Math.max(0, Math.floor(nextCount)) : 0);
                }
            } catch (error) {
