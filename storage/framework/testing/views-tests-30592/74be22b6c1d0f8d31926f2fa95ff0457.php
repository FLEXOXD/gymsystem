...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'primary','class' => 'js-class-edit-trigger','aria-haspopup' => 'dialog','aria-controls' => 'class-edit-modal','data-open-class-edit' => true,'data-class-id' => ''.e((int) $nextClass->id).'','data-class-update-url' => ''.e(route('classes.update', $routeParams + ['gymClass' => $nextClass->id])).'','data-class-detail-url' => ''.e(route('classes.show', $routeParams + ['gymClass' => $nextClass->id])).'','data-class-name' => ''.e($nextClass->name).'','data-class-category' => ''.e($nextClass->category ?: '').'','data-class-level' => ''.e($nextClass->level ?: '').'','data-class-instructor' => ''.e($nextClass->instructor_name ?: '').'','data-class-room' => ''.e($nextClass->room_name ?: '').'','data-class-capacity' => ''.e((int) $nextClass->capacity).'','data-class-price' => ''.e(number_format((float) ($nextClass->price ?? 0), 2, '.', '')).'','data-class-starts-at' => ''.e(optional($nextClass->starts_at)->format('Y-m-d\\TH:i')).'','data-class-starts-label' => ''.e(optional($nextClass->starts_at)->format('d/m/Y H:i')).'','data-class-ends-at' => ''.e(optional($nextClass->ends_at)->format('Y-m-d\\TH:i')).'','data-class-status' => ''.e($nextClass->status).'','data-class-description' => ''.e($nextClass->description ?: '').'','data-class-allow-waitlist' => ''.e($nextClass->allow_waitlist ? '1' : '0').'','data-class-reserved-count' => ''.e((int) $nextClass->reserved_count).'','data-class-waitlist-count' => ''.e((int) $nextClass->waitlist_count).'','data-class-gym' => ''.e($nextClassGymLabel).'']); ?>Editar proxima clase <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
