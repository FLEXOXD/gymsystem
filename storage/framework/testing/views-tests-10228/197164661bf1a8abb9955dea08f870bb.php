    ...
    <main class="guide-wrap">
        ...
        <section class="hero">
            ...
            <div class="cta">
                ...
                <a class="btn btn-soft" href="<?php echo e($content['whatsapp_url']); ?>" target="_blank" rel="noreferrer">Hablar por WhatsApp</a>
            </div>
        </section>
        ...
        <section class="steps" aria-label="Pasos de demo guiada">
            ...
            <article class="step">
                ...
                <p><?php echo e($content['guide_step_3_text'] ?? 'Activa membresias y prueba recepcion.'); ?></p>
            </article>
            <article class="step">
                <span class="step-index">4</span>
                <h2><?php echo e($content['guide_step_4_title'] ?? 'Paso 4'); ?></h2>
                <p><?php echo e($content['guide_step_4_text'] ?? 'Valida caja, cobros y reportes.'); ?></p>
            </article>
            <article class="step" style="grid-column: 1 / -1;">
                <span class="step-index">5</span>
                <h2><?php echo e($content['guide_step_5_title'] ?? 'Paso 5'); ?></h2>
                <p><?php echo e($content['guide_step_5_text'] ?? 'Confirma configuracion final antes de operar.'); ?></p>
            </article>
        </section>
