...
<?php $__env->startSection('content'); ?>
    <?php
        ...
        $editorSections = [
            ...
            ['id' => 'editor-services', 'label' => 'Servicios'],
...
<?php $component->withAttributes(['title' => 'Contenido comercial','subtitle' => 'Editor visual de landing para editar por secciones y ver la vista previa al instante.']); ?>
                <form id="site-content-form" method="POST" action="<?php echo e(route('superadmin.web-page.update')); ?>" enctype="multipart/form-data" class="site-content-editor grid gap-4 text-slate-800 lg:grid-cols-2">
                    <?php echo csrf_field(); ?>
                    ...
                    <section id="editor-footer" class="editor-block lg:col-span-2 grid gap-4 lg:grid-cols-2 rounded-xl border border-slate-300/70 bg-slate-50/60 p-3">
                        ...
                        <label class="space-y-1 text-xs font-bold uppercase tracking-wide lg:col-span-2">
                            ...
                            <input type="email" name="footer_contact_email" data-preview-field="footer_contact_email" class="ui-input" value="<?php echo e(old('footer_contact_email', $content['footer_contact_email'] ?? 'soporte@gymsystem.local')); ?>">
                        </label>
                    </section>
