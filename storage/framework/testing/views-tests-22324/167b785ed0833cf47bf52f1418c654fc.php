...
<?php endif; ?>
            ...
            <div id="products-ops-modal" class="ui-modal-backdrop <?php echo e($productModalOpen || $stockModalOpen ? '' : 'hidden'); ?>" role="dialog" aria-modal="true" aria-labelledby="products-ops-modal-title" aria-hidden="<?php echo e($productModalOpen || $stockModalOpen ? 'false' : 'true'); ?>">
                ...
                <x-ui.card :title="$editingProduct ? 'Editar producto' : 'Registrar producto'" subtitle="Define precio, costo, categoria y stock minimo del producto." class="products-surface-card" data-products-panel="product" <?php if($stockModalOpen && ! $productModalOpen): ?> hidden <?php endif; ?>>
...
<?php endif; ?>
                ...
                <x-ui.card title="Mover stock" subtitle="Registra entradas o ajustes manuales de inventario." class="products-surface-card self-start" data-products-panel="stock" <?php if($productModalOpen && ! $stockModalOpen): ?> hidden <?php endif; ?>>
