...
<?php endif; ?>
            ...
            <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500 dark:text-slate-400">
                Dias activos: <?php echo e($classModel->activeWeekdaysLabel(true)); ?>
...
<?php endif; ?>
        ...
        <section class="class-detail-summary">
            ...
            <article class="class-detail-stat">
                ...
                <p class="class-detail-stat-value text-lg !tracking-normal"><?php echo e($classModel->activeWeekdaysLabel()); ?></p>
            </article>
        </section>
...
<?php $component->withAttributes(['title' => 'Informacion de la clase','subtitle' => 'Resumen operativo de la sesion.']); ?>
                    <dl class="grid gap-3 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm font-semibold text-slate-900 dark:text-slate-100"><?php echo e($classModel->activeWeekdaysLabel(true)); ?></dd>
                        </div>
                    </dl>
