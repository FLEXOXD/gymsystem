<?php
    ...
    $weekdayLabel = $classItem instanceof \App\Models\GymClass
    ...
    <div class="flex items-start justify-between gap-3">
        <div class="min-w-0">
            ...
            <p class="mt-1 text-xs text-slate-300">
                <?php echo e($formatClassRange($classItem->starts_at ?? null, $classItem->ends_at ?? null)); ?>

            </p>
            <p class="text-[11px] text-slate-400">Dias: <?php echo e($weekdayLabel); ?></p>
        </div>
        <div class="flex flex-col items-end gap-2">
            <span class="inline-flex items-center rounded-full border px-3 py-1 text-[10px] font-black uppercase tracking-[.14em] <?php echo e($priceClasses); ?>">
