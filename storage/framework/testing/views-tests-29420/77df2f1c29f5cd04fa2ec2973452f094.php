...
<?php endif; ?>
        ...
        <?php if($premiumReportsDashboard): ?>
            <?php
                $premiumReportAlerts = collect($premiumReportsDashboard['alerts'] ?? [])->values();
                $premiumReportMetrics = [
                    ...
                    [
                        ...
                        'note' => 'Portal y app ya activos en la base.',
                        'tone' => 'accent',
                    ],
                    [
                        'label' => 'Pendientes app',
                        'value' => (string) ((int) ($premiumReportsDashboard['active_clients_without_app_access_count'] ?? 0)),
                        'note' => 'Clientes activos aun sin experiencia premium completa.',
                        'tone' => 'warning',
                    ],
                    [
                        'label' => 'Ticket promedio',
                        'value' => $currencyFormatter::format((float) ($premiumReportsDashboard['average_ticket'] ?? 0), $appCurrencyCode, true),
                        'note' => 'Promedio por venta de productos del rango.',
                        'tone' => 'info',
                    ],
                ];
            ?>
                ...
                <div class="report-pro-grid">
                    <div class="flex flex-wrap items-start justify-between gap-3">
                        <div class="report-pro-copy">
                            ...
                            <h2 class="report-pro-heading"><?php echo e($premiumReportsDashboard['headline'] ?? 'Lectura premium del negocio y canal digital'); ?></h2>
                            <p class="report-pro-summary"><?php echo e($premiumReportsDashboard['summary'] ?? 'Mide ingresos, clientes con app y valor premium activado antes de bajar al detalle.'); ?></p>
                        </div>
                    ...
                    <?php if($premiumReportAlerts->isNotEmpty()): ?>
                        <div class="report-pro-insights">
                            <?php $__currentLoopData = $premiumReportAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <article class="report-pro-chip" data-tone="<?php echo e($alert['tone'] ?? 'info'); ?>">
                                    <p class="report-pro-chip-title"><?php echo e($alert['title'] ?? 'Alerta'); ?></p>
                                    <p class="report-pro-chip-copy"><?php echo e($alert['description'] ?? ''); ?></p>
                                </article>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('reports.memberships', $membershipsRouteParams)),'variant' => 'ghost']); ?>Estado membresias <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
