...
<?php $__env->startSection('content'); ?>
    <?php
        ...
        $adjustmentTypeLabels = [
            'reschedule_start' => 'Reprogramar inicio',
            'extend_access' => 'Extender acceso',
            'manual_window' => 'Definir ventana manual',
        ];
        ...
        $openAdjustmentModal = (bool) old('_open_adjust_membership_modal', false)
            ...
            return {
                ...
                setSelectedAdjustmentMembership(membershipId, preserveValues = false) {
                    ...
                    if (!preserveValues) {
                        ...
                        this.adjustmentForm.reason = 'payment_registered_late';
