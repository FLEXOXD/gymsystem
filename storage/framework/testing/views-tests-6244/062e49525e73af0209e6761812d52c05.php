...
<?php endif; ?>
                ...
                <div class="flex max-w-4xl flex-wrap items-center gap-x-2 gap-y-1 text-sm leading-6 text-slate-600 dark:text-slate-300">
                    ...
                    <span><?php echo e($membershipDateLabel); ?>: <span class="font-semibold text-slate-900 dark:text-slate-100"><?php echo e($membershipDateValue); ?></span></span>
                    <span class="text-slate-500">|</span>
                    <span><?php echo e($membershipCountdownLabel); ?>: <span class="font-semibold text-slate-900 dark:text-slate-100"><?php echo e($membershipCountdownValue); ?></span></span>
                    <span class="text-slate-500">|</span>
                    <span>Última asistencia: <span class="font-semibold text-slate-900 dark:text-slate-100"><?php echo e($lastAttendanceLabel); ?></span></span>
                </div>
            </div>
        </div>
...
<?php endif; ?>
            ...
            <?php if(! empty($canShowProgress) && ! empty($progressTabUrl)): ?>
                <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => $progressTabUrl,'variant' => 'secondary','class' => 'px-5 py-2.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($progressTabUrl),'variant' => 'secondary','class' => 'px-5 py-2.5']); ?>
                    Ver rendimiento
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
...
<?php endif; ?>
                ...
                <div x-cloak
                    ...
                    <?php if(! empty($canAdjustMemberships) && $latestMembership): ?>
                        <button type="button"
                                class="flex w-full items-center justify-between rounded-lg px-3 py-2 text-left text-sm text-slate-200 transition hover:bg-slate-800"
                                x-on:click="openMembershipAdjustmentModal(<?php echo e((int) $latestMembership->id); ?>)">
