    ...
    <div class="mx-auto flex max-w-full gap-2 overflow-x-auto px-1 pb-1">
        <?php $__currentLoopData = $navItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a href="<?php echo e(route($item['route'], $item['params'] ?? [])); ?>"
               class="min-w-[84px] shrink-0 rounded-lg px-2 py-2 text-center text-[11px] font-bold uppercase tracking-wide <?php echo e($isActive ? 'theme-nav-mobile-active' : 'theme-nav-mobile-link'); ?>">
