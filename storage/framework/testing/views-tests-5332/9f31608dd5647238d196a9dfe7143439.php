...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Clientes: foco comercial','subtitle' => 'Renovaciones, promos y movimiento diario para el plan Profesional.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Clientes: foco comercial','subtitle' => 'Renovaciones, promos y movimiento diario para el plan Profesional.']); ?>
                <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
                    <div>
                        <div class="flex flex-wrap items-start justify-between gap-3">
                            <div class="max-w-3xl">
                                <p class="text-sm font-black text-slate-900 dark:text-slate-100"><?php echo e($professionalClientsDashboard['headline'] ?? 'Base comercial de clientes'); ?></p>
                                <p class="mt-1 text-sm text-slate-600 dark:text-slate-300"><?php echo e($professionalClientsDashboard['summary'] ?? 'Usa esta capa para renovar, recuperar y empujar promos.'); ?></p>
                            </div>
                        ...
                        <div class="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                            <article class="rounded-xl border border-amber-200 bg-amber-50 p-3 dark:border-amber-400/40 dark:bg-amber-500/15">
                                <p class="text-xs font-bold uppercase tracking-wider text-amber-700 dark:text-amber-200">Renovaciones por mover</p>
                                <p class="mt-2 text-2xl font-black text-amber-800 dark:text-amber-100"><?php echo e((int) ($professionalClientsDashboard['renewal_opportunities'] ?? 0)); ?></p>
                                <p class="mt-1 text-xs text-amber-700 dark:text-amber-200">Por vencer + vencidos listos para cobrar.</p>
                            </article>

                            <article class="rounded-xl border border-rose-200 bg-rose-50 p-3 dark:border-rose-400/40 dark:bg-rose-500/15">
                                <p class="text-xs font-bold uppercase tracking-wider text-rose-700 dark:text-rose-200">Clientes vencidos</p>
                                <p class="mt-2 text-2xl font-black text-rose-800 dark:text-rose-100"><?php echo e((int) ($professionalClientsDashboard['expired_count'] ?? 0)); ?></p>
                                <p class="mt-1 text-xs text-rose-700 dark:text-rose-200">Base fria que aun puedes recuperar.</p>
                            </article>

                            <article class="rounded-xl border border-violet-200 bg-violet-50 p-3 dark:border-violet-400/40 dark:bg-violet-500/15">
                                <p class="text-xs font-bold uppercase tracking-wider text-violet-700 dark:text-violet-200">Promos activas</p>
                                <p class="mt-2 text-2xl font-black text-violet-800 dark:text-violet-100"><?php echo e((int) ($professionalClientsDashboard['active_promotions_count'] ?? 0)); ?></p>
                                <p class="mt-1 text-xs text-violet-700 dark:text-violet-200">Campanas listas para mover renovaciones.</p>
                            </article>

                            <article class="rounded-xl border border-cyan-200 bg-cyan-50 p-3 dark:border-cyan-400/40 dark:bg-cyan-500/15">
                                <p class="text-xs font-bold uppercase tracking-wider text-cyan-700 dark:text-cyan-200">Clientes con promo</p>
                                <p class="mt-2 text-2xl font-black text-cyan-800 dark:text-cyan-100"><?php echo e((int) ($professionalClientsDashboard['clients_with_promotion_count'] ?? 0)); ?></p>
                                <p class="mt-1 text-xs text-cyan-700 dark:text-cyan-200">Check-ins hoy <?php echo e((int) ($professionalClientsDashboard['attended_today_count'] ?? 0)); ?></p>
                            </article>
                        </div>
                    </div>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Clientes del gimnasio','subtitle' => 'Vista operacional para recepción, renovaciones y retención.','class' => 'clients-main-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Clientes del gimnasio','subtitle' => 'Vista operacional para recepción, renovaciones y retención.','class' => 'clients-main-card']); ?>
            <div class="space-y-4">
