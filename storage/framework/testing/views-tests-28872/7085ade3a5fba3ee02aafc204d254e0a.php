<?php if (! $__env->hasRenderedOnce('32b35c67-5565-405d-8d3b-06a0c9229adb')): $__env->markAsRenderedOnce('32b35c67-5565-405d-8d3b-06a0c9229adb'); ?>
    <style>
...
<?php
    ...
    $formatClassRange = static function ($startsAt, $endsAt) use ($parseClassMoment, $formatClassMoment): string {
        ...
        return $formatClassMoment($startMoment, 'D d M - H:i')
            .' hasta '
            .$formatClassMoment($endMoment, 'D d M - H:i');
    };
...
<?php if (! $__env->hasRenderedOnce('d9ae3f70-7d14-48e4-a952-c734895df1e0')): $__env->markAsRenderedOnce('d9ae3f70-7d14-48e4-a952-c734895df1e0'); ?>
    <script>
        (function () {
