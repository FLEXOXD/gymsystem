...
<head>
    ...
    <link rel="manifest" href="<?php echo e(route('client-mobile.manifest', ['gymSlug' => $gym->slug, 'v' => '20260317'])); ?>">
...
<main
    class="mobile-shell px-4 pt-6 pb-6 <?php echo e($screen === 'progress' ? 'has-training-fab' : ''); ?>"
    ...
    <section class="mx-auto max-w-md space-y-4 relative z-10">
        <div class="top-user-menu">
            ...
            <div id="user-menu-panel" class="user-dropdown hidden" role="menu" aria-hidden="true">
                ...
                <a href="<?php echo e(route('client-mobile.app', ['gymSlug' => $gym->slug, 'screen' => 'nutrition'])); ?>" class="user-dropdown-item user-dropdown-link" role="menuitem">Guía nutricional</a>
                <?php if($classesEnabled): ?>
                    <a href="<?php echo e(route('client-mobile.app', ['gymSlug' => $gym->slug, 'screen' => 'classes'])); ?>" class="user-dropdown-item user-dropdown-link" role="menuitem">Clases y reservas</a>
                <?php endif; ?>
        ...
        <?php if($showGlobalClientAlert): ?>
            <article class="glass-card rounded-3xl p-4 space-y-1">
                <?php if(session('status')): ?>
                    ...
                    <p class="text-sm font-semibold text-white"><?php echo e(session('status')); ?></p>
                <?php endif; ?>
                <?php if($errors->any() && ! ($screen === 'classes' && $errors->has('classes'))): ?>
                    <p class="text-xs font-black uppercase tracking-[.15em] text-rose-200">Aviso</p>
                    <p class="text-sm font-semibold text-white"><?php echo e($errors->first()); ?></p>
                <?php endif; ?>
            </article>
        <?php endif; ?>
        ...
        <?php if($screen === 'home'): ?>
            <section id="home-view" class="home-stage">
                ...
                <?php if($fitnessProfileCompleted): ?>
                    <a href="<?php echo e(route('client-mobile.app', ['gymSlug' => $gym->slug, 'screen' => 'nutrition'])); ?>" class="menu-cta menu-nutrition home-btn" aria-label="Abrir guía nutricional personalizada">
                        <span class="action-badge" aria-hidden="true">
                            <svg class="action-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
                ...
                <?php if($classesEnabled): ?>
                    <article class="glass-card rounded-3xl p-4 space-y-3">
                        <div class="flex items-start justify-between gap-3">
                            ...
                            <a href="<?php echo e(route('client-mobile.app', ['gymSlug' => $gym->slug, 'screen' => 'classes'])); ?>" class="module-action module-action-secondary">Abrir</a>
                        </div>
                        <?php if($nextGymClassReservation && $nextGymClassReservation->gymClass): ?>
                            <p class="text-sm font-semibold text-white">Proxima: <?php echo e((string) ($nextGymClassReservation->gymClass->name ?? 'Clase reservada')); ?></p>
                            <p class="text-xs text-slate-300">
                                <?php echo e((string) ($nextGymClassReservation->gymClass->starts_at?->format('Y-m-d H:i') ?? '-')); ?>

                                -
                                <?php echo e(($nextGymClassReservation->status ?? null) === \App\Models\GymClassReservation::STATUS_WAITLIST ? 'Sigues en lista de espera.' : 'Tu cupo ya esta reservado.'); ?>
            ...
            <section id="nutrition-view" class="nutrition-screen">
                <article class="nutrition-header-card">
                    <div class="nutrition-header-top">
                        ...
                        <?php if($nutritionTargetKcal !== null): ?>
                            <span class="nutrition-header-chip"><?php echo e($nutritionTargetKcal); ?> kcal/día</span>
                        <?php endif; ?>
                    </div>
                    <h2 class="nutrition-header-title"><?php echo e($nutritionTitle !== '' ? $nutritionTitle : 'Nutrición personalizada'); ?></h2>
                    <p class="nutrition-header-subtitle"><?php echo e($nutritionSubtitle !== '' ? $nutritionSubtitle : 'Esto debes comer hoy según tus datos.'); ?></p>
                    <div class="nutrition-header-lines">
                        <p class="nutrition-header-line">Objetivo actual: <?php echo e($nutritionGoalLabel !== '' ? $nutritionGoalLabel : 'General'); ?>.</p>
                        <p class="nutrition-header-line"><?php echo e($nutritionSummaryLine !== '' ? $nutritionSummaryLine : 'Sin resumen por ahora.'); ?></p>
                        <p class="nutrition-header-line"><?php echo e($nutritionImpactLine !== '' ? $nutritionImpactLine : 'Sin impacto estimado por ahora.'); ?></p>
                    </div>
                </article>
                ...
                <?php if($nutritionReady && count($nutritionItems) > 0): ?>
                    ...
                    <article class="glass-card rounded-3xl p-4">
                        ...
                        <div class="nutrition-totals-grid mt-3">
                            <div class="nutrition-total-card">
                                ...
                                <p id="nutrition-total-kcal" class="nutrition-total-value"><?php echo e($nutritionTotalKcal); ?> kcal</p>
                            </div>
                            <div class="nutrition-total-card">
                                <p class="nutrition-total-label">Mantenimiento</p>
                                <p id="nutrition-maintenance-kcal" class="nutrition-total-value"><?php echo e($nutritionMaintenanceKcal !== null ? $nutritionMaintenanceKcal.' kcal' : '-'); ?></p>
                            </div>
                            <div class="nutrition-total-card">
                                <p class="nutrition-total-label">Proteína total</p>
                                <p id="nutrition-total-protein" class="nutrition-total-value"><?php echo e($nutritionTotalProtein); ?> g</p>
                            </div>
                            <div class="nutrition-total-card">
                                <p class="nutrition-total-label">Carb/Grasa total</p>
                                <p class="nutrition-total-value">
                                    <span id="nutrition-total-carbs"><?php echo e($nutritionTotalCarbs); ?></span> g
                                    /
                                    <span id="nutrition-total-fat"><?php echo e($nutritionTotalFat); ?></span> g
                                </p>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="glass-card rounded-3xl p-4">
                        ...
                        <div id="nutrition-day-list" class="nutrition-day-list mt-3">
                            <?php $__currentLoopData = $nutritionItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nutritionItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <article class="nutrition-day-item">
                                    <img
                                        src="<?php echo e((string) ($nutritionItem['image_url'] ?? asset('images/nutrition/nutri-lunch.svg'))); ?>"
                                    ...
                                    <div>
                                        <div class="nutrition-day-head">
                                            <p class="nutrition-day-slot"><?php echo e((string) ($nutritionItem['slot'] ?? 'Comida')); ?></p>
                                            <p class="nutrition-day-kcal"><?php echo e((int) ($nutritionItem['kcal'] ?? 0)); ?> kcal</p>
                                        </div>
                                        <p class="nutrition-day-dish"><?php echo e((string) ($nutritionItem['dish'] ?? 'Plato sugerido')); ?></p>
                                        <p class="nutrition-day-portion"><?php echo e((string) ($nutritionItem['portion'] ?? 'Porción sugerida')); ?></p>
                                        <p class="nutrition-day-macros">
                                            P <?php echo e((int) ($nutritionItem['protein_g'] ?? 0)); ?>g
                                            | C <?php echo e((int) ($nutritionItem['carbs_g'] ?? 0)); ?>g
                                            | G <?php echo e((int) ($nutritionItem['fat_g'] ?? 0)); ?>g
                                        </p>
                                    </div>
                                </article>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($nutritionFootnote !== ''): ?>
                        <p id="nutrition-screen-footnote" class="nutrition-screen-footnote"><?php echo e($nutritionFootnote); ?></p>
                    <?php endif; ?>
                    ...
                    <div id="nutrition-customize-modal" class="nutrition-customize-modal hidden" aria-hidden="true">
                        ...
                        <article class="nutrition-customize-panel" role="dialog" aria-modal="true" aria-labelledby="nutrition-customize-title">
                            ...
                            <div class="nutrition-customize-groups">
                                <?php $__currentLoopData = $nutritionIngredientGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nutritionGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <section class="nutrition-customize-group">
                                        <p class="nutrition-customize-group-title"><?php echo e((string) ($nutritionGroup['title'] ?? 'Ingredientes')); ?></p>
                                        <div class="nutrition-customize-chip-grid">
                                            <?php $__currentLoopData = (array) ($nutritionGroup['items'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nutritionIngredient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $ingredientKey = trim((string) ($nutritionIngredient['key'] ?? ''));
                                                    $ingredientLabel = trim((string) ($nutritionIngredient['label'] ?? $ingredientKey));
                                                ?>
                                                <?php if($ingredientKey !== ''): ?>
                                                    <button
                                                        type="button"
                                                        class="nutrition-customize-chip"
                                                        data-nutrition-ingredient="<?php echo e($ingredientKey); ?>"
                                                        aria-pressed="false"
                                                    >
                                                        <?php echo e($ingredientLabel); ?>
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('client-mobile.app', ['gymSlug' => $gym->slug, 'screen' => 'physical'])); ?>" class="module-action module-action-secondary">
            ...
            <section id="progress-view" class="space-y-4">
                ...
                <article class="today-summary-card">
                    <div class="today-summary-head">
                        ...
                        <span id="today-summary-state-chip" class="today-summary-chip <?php echo e($todaySummaryChipClass); ?>"><?php echo e($todaySummaryStateLabel); ?></span>
                    </div>
                    <div class="today-summary-grid">
                        <div class="today-summary-item">
                            <p class="today-summary-label">Asistencia</p>
                            <p id="today-summary-attendance" class="today-summary-value"><?php echo e($todaySummaryAttendanceLabel); ?></p>
                        </div>
                        <div class="today-summary-item">
                            <p class="today-summary-label">Meta semanal</p>
                            <p id="today-summary-weekly" class="today-summary-value"><?php echo e($todaySummaryWeeklyLabel); ?></p>
                        </div>
                        <div class="today-summary-item">
                            <p class="today-summary-label">Tiempo activo</p>
                            <p id="today-summary-timer" class="today-summary-value"><?php echo e($todaySummaryTimer); ?></p>
                        </div>
                    </div>
                    <p id="today-summary-tip" class="today-summary-tip"><?php echo e($todaySummaryTip); ?></p>
                </article>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="progress-lock-content">
                            ...
                            <ul id="training-plan-list" class="training-list">
                                <?php if($trainingExercises !== []): ?>
                                    <?php $__currentLoopData = $trainingExercises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exerciseIndex => $exercise): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <li class="training-item">
                                            <span class="training-item-left">
                                                <button
                                                    ...
                                                    data-training-check="exercise-<?php echo e($exerciseIndex); ?>"
                                                    aria-pressed="false"
                            ...
                            <div class="training-completion-box">
                                <div class="training-completion-head">
                                    ...
                                    <p id="training-completion-value" class="training-completion-value">0/<?php echo e(min(6, count($trainingExercises))); ?> ejercicios</p>
                                </div>
            ...
            <div id="training-fab-dock" class="training-fab-dock">
                <div class="training-fab-shell">
                    <div class="training-fab-status-row">
                        <p id="training-session-status" class="training-fab-status"><?php echo e($trainingStatusLabel); ?></p>
                        <p id="training-session-timer" class="training-fab-timer <?php echo e($trainingIsActive ? '' : 'hidden'); ?>">
                            <span id="training-session-timer-value"><?php echo e($trainingTimerLabel); ?></span>
                        </p>
                    </div>
                    <div class="training-session-actions">
                        ...
                        <button
                            ...
                            type="button"
                            class="module-action training-idle-btn <?php echo e(($trainingCanStart || $trainingCanFinish) ? 'hidden' : ''); ?>"
                            disabled
                        >
                            <?php echo e($trainingHasAttendanceToday ? 'Entrenamiento completado' : 'Registra asistencia para iniciar'); ?>
        ...
        <?php endif; ?>
        <?php if($screen === 'classes' && $classesEnabled): ?>
            <?php echo $__env->make('client-mobile.partials.classes-screen', [
                'gym' => $gym,
                    ...
                    <?php if($fitnessProfileCompleted): ?>
                        <div class="fitness-meta-grid">
                            <div class="fitness-meta-card">
                                ...
                                <p class="fitness-meta-value"><?php echo e($fitnessBirthDateLabel); ?></p>
                            </div>
                            <div class="fitness-meta-card">
                                <p class="fitness-meta-label">Edad (auto)</p>
                                <p class="fitness-meta-value"><?php echo e($fitnessAgeLabel); ?></p>
                            </div>
                            <div class="fitness-meta-card">
                            ...
                            <div class="fitness-meta-card">
                                ...
                                <p class="fitness-meta-value"><?php echo e($fitnessPrimaryGoalLabel); ?></p>
                            </div>
                            <div class="fitness-meta-card">
                                <p class="fitness-meta-label">Objetivo secundario</p>
                                <p class="fitness-meta-value"><?php echo e($fitnessSecondaryGoalLabel !== '' ? $fitnessSecondaryGoalLabel : 'Sin secundario'); ?></p>
                            </div>
                            <div class="fitness-meta-card">
...
(function () {
    ...
    const nutritionInitialPayload = <?php echo json_encode($nutritionClientPayload, 15, 512) ?>;
    const nutritionImageMap = {
        breakfast: <?php echo json_encode(asset('images/nutrition/nutri-breakfast.svg'), 15, 512) ?>,
        lunch: <?php echo json_encode(asset('images/nutrition/nutri-lunch.svg'), 15, 512) ?>,
        snack: <?php echo json_encode(asset('images/nutrition/nutri-snack.svg'), 15, 512) ?>,
        dinner: <?php echo json_encode(asset('images/nutrition/nutri-dinner.svg'), 15, 512) ?>,
    };
