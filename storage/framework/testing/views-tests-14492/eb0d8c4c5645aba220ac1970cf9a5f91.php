...
<?php endif; ?>
        ...
        <section class="sa-stat-grid">
            ...
            <article class="sa-stat-card is-success">
                ...
                <p class="sa-stat-meta"><?php echo e($portfolioHealth); ?>% de la cartera está operando sin alertas.</p>
            </article>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Gestión de suscripciones','subtitle' => 'Menos columnas, mejor jerarquia visual y acciones agrupadas por contexto.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Gestión de suscripciones','subtitle' => 'Menos columnas, mejor jerarquia visual y acciones agrupadas por contexto.']); ?>
                                        ...
                                        <details class="sa-disclosure" data-renew-panel>
                                            ...
                                            <div class="space-y-3 p-4">
                                                ...
                                                <form method="POST"
                                                      ...
                                                      data-current-plan-key="<?php echo e(strtolower(trim((string) ($currentPlanTemplate->plan_key ?? $gym->plan_key ?? '')))); ?>"
                                                      data-current-plan-price="<?php echo e(number_format((float) ($currentPlanTemplate->price ?? $gym->price ?? 0), 2, '.', '')); ?>">
                                                    <?php echo csrf_field(); ?>
                                                        ...
                                                        <select name="plan_template_id" class="ui-input js-plan-template-select">
                                                            ...
                                                            <?php $__currentLoopData = ($planTemplates ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <option value="<?php echo e($template->id); ?>"
                                                                    ...
                                                                    <?php echo e($template->name); ?> (<?php echo e(\App\Support\PlanDuration::label($template->duration_unit, (int) $template->duration_days, $template->duration_months)); ?>) - <?php echo e(\App\Support\Currency::format((float) $template->price, $appCurrencyCode)); ?><?php echo e($template->discount_price !== null ? ' | Desc. '.\App\Support\Currency::format((float) $template->discount_price, $appCurrencyCode) : ''); ?>
...
<script>
    (function () {
        ...
        const promotionRules = <?php echo json_encode($planPromotionRules, 15, 512) ?>;
