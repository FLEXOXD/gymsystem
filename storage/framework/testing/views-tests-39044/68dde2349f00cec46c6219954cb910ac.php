...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('superadmin.gyms.index'),'variant' => 'secondary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('superadmin.gyms.index')),'variant' => 'secondary']); ?>Ver cartera <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('superadmin.gyms.store')); ?>" enctype="multipart/form-data" class="sa-form-workbench grid gap-5 xl:grid-cols-[minmax(0,1.35fr)_minmax(300px,0.85fr)]" aria-describedby="gym-create-form-help">
            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => '1. Datos del gimnasio','subtitle' => 'Ubicación y datos base de la sede principal.','class' => 'sa-form-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => '1. Datos del gimnasio','subtitle' => 'Ubicación y datos base de la sede principal.','class' => 'sa-form-card']); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => '2. Operación base','subtitle' => 'Zona horaria, moneda e idioma para operar desde el primer día.','class' => 'sa-form-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => '2. Operación base','subtitle' => 'Zona horaria, moneda e idioma para operar desde el primer día.','class' => 'sa-form-card']); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => '3. Oferta inicial','subtitle' => 'Define el paquete comercial y la oferta con la que nacerá la cuenta.','class' => 'sa-form-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => '3. Oferta inicial','subtitle' => 'Define el paquete comercial y la oferta con la que nacerá la cuenta.','class' => 'sa-form-card']); ?>
                    <div class="space-y-4">
                        <div class="grid gap-3 md:grid-cols-2">
                            <?php $__empty_1 = true; $__currentLoopData = $planTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <label class="flex cursor-pointer items-start gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 transition hover:border-cyan-300 hover:bg-cyan-50/60 dark:border-slate-800 dark:bg-slate-950/50 dark:hover:border-cyan-500/40 dark:hover:bg-cyan-500/10">
                                    <input type="radio"
                                           ...
                                           data-plan-template-id="<?php echo e($templateId); ?>"
                                           ...
                                           <?php if((string) $defaultPlanTemplateId === (string) $template->id): echo 'checked'; endif; ?>
                                           required>
                                    <span class="block">
                                        ...
                                        <span class="mt-1 inline-flex rounded-full bg-cyan-100 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide text-cyan-800 dark:bg-cyan-900/40 dark:text-cyan-200">
                                            Slot <?php echo e($templateSlotName); ?>

                                        </span>
                                        <span class="mt-1 block text-xs text-slate-600 dark:text-slate-300">
                                            <?php echo e(\App\Support\PlanDuration::label($template->duration_unit, (int) $template->duration_days, $template->duration_months)); ?>
                                        ...
                                        <span class="mt-2 inline-flex rounded-full bg-slate-200 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide text-slate-700 dark:bg-slate-800 dark:text-slate-200">
                                            <?php echo e(\App\Support\Currency::format((float) $template->price, $appCurrencyCode ?? 'USD')); ?>

                                        </span>
                                        <?php if($templateOfferText !== ''): ?>
                                            <span class="mt-2 block text-xs font-semibold text-cyan-700 dark:text-cyan-300">
                                                <?php echo e($templateOfferText); ?>

                                            </span>
                                        <?php endif; ?>
                                        <?php if($planPromotions->isNotEmpty()): ?>
                                            <span class="mt-3 block">
                                                <span class="ui-muted mb-1 block text-[11px] font-bold uppercase tracking-wide">Promociones activas</span>
                                                <span class="flex flex-wrap gap-2">
                                                    <?php $__currentLoopData = $planPromotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotionRule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                        ...
                                                        <span class="inline-flex rounded-full bg-cyan-100 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide text-cyan-800 dark:bg-cyan-900/40 dark:text-cyan-200">
                                                            <?php echo e($promotionDurationLabel); ?> · <?php echo e($promotionLabel); ?>
                        ...
                        <?php $__errorArgs = ['subscription_plan_template_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="text-xs font-semibold text-rose-600 dark:text-rose-300"><?php echo e($message); ?></p>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950/50">
                            ...
                            <?php $__errorArgs = ['subscription_promotion_template_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="subscription-billing-cycles-wrap" class="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950/50">
                            ...
                            <select id="subscription-billing-cycles" name="subscription_billing_cycles" class="ui-input">
                                <?php for($billingCycleOption = 1; $billingCycleOption <= 12; $billingCycleOption++): ?>
                                    <option value="<?php echo e($billingCycleOption); ?>" <?php if((string) $defaultSubscriptionBillingCycles === (string) $billingCycleOption): echo 'selected'; endif; ?>>
                                        <?php echo e($commercialBillingCycleLabels[$billingCycleOption] ?? ($billingCycleOption.' '.($billingCycleOption === 1 ? 'mes' : 'meses'))); ?>
                            ...
                            <?php $__errorArgs = ['subscription_billing_cycles'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="grid gap-3 md:grid-cols-[minmax(0,1fr)] md:items-end">
                                <div>
                                    ...
                                    <input id="subscription-custom-price"
                                           ...
                                           value="<?php echo e($defaultSubscriptionCustomPrice); ?>"
                                           step="0.01"
                                           min="0"
                                           class="ui-input"
                                    ...
                                    <?php $__errorArgs = ['subscription_custom_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => '4. Admin principal','subtitle' => 'Datos de la persona que recibirá el acceso inicial del gimnasio.','class' => 'sa-form-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => '4. Admin principal','subtitle' => 'Datos de la persona que recibirá el acceso inicial del gimnasio.','class' => 'sa-form-card']); ?>
                    <div class="grid gap-3 lg:grid-cols-3">
                        <div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="admin_birth_date" value="<?php echo e($defaultAdminBirthDate); ?>" class="ui-input" max="<?php echo e(now()->format('Y-m-d')); ?>">
                            <?php $__errorArgs = ['admin_birth_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="admin_identification_type" class="ui-input">
                                ...
                                <option value="cédula" <?php if($defaultAdminIdentificationType === 'cédula'): echo 'selected'; endif; ?>>Cédula</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="admin_phone_country_dial" value="<?php echo e($defaultAdminPhoneCountryDial); ?>" class="ui-input" placeholder="+593">
                            <?php $__errorArgs = ['admin_phone_country_dial'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="admin_phone_number" value="<?php echo e($defaultAdminPhoneNumber); ?>" class="ui-input" placeholder="0991234567">
                            <?php $__errorArgs = ['admin_phone_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="lg:col-span-3">
                            ...
                            <?php $__errorArgs = ['admin_profile_photo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => '5. Seguridad de acceso','subtitle' => 'Credenciales iniciales para el primer ingreso del administrador.','class' => 'sa-form-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => '5. Seguridad de acceso','subtitle' => 'Credenciales iniciales para el primer ingreso del administrador.','class' => 'sa-form-card']); ?>
                    <div class="grid gap-3 md:grid-cols-2">
                        <div>
...
<?php endif; ?>
            ...
            <aside class="space-y-5">
                <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Resumen operativo','subtitle' => 'Puntos a revisar antes de confirmar la creacion.','class' => 'sa-form-review']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Resumen operativo','subtitle' => 'Puntos a revisar antes de confirmar la creacion.','class' => 'sa-form-review']); ?>
...
<?php endif; ?>
                ...
                <div class="sa-danger-zone">
                    ...
                    <div class="mt-4 flex flex-col gap-2">
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('superadmin.gyms.index'),'variant' => 'ghost']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('superadmin.gyms.index')),'variant' => 'ghost']); ?>Cancelar y volver <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<script>
    (function () {
        ...
        const promotionTemplates = <?php echo json_encode($promotionTemplateOptions, 15, 512) ?>;
        const billingCycleLabels = <?php echo json_encode($commercialBillingCycleLabels, 15, 512) ?>;
        const defaultPromotionTemplateId = <?php echo json_encode((string) $defaultPromotionTemplateId, 15, 512) ?>;
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\gymsystem\resources\views/superadmin/gym.blade.php ENDPATH**/ ?>