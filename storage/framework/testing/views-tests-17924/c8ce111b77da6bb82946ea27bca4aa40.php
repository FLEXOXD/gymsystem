<?php
    ...
    $navItems = $isSuperAdmin
        ? [
            ...
            ['label' => 'Listado de gimnasios', 'route' => 'superadmin.gym-list.index', 'params' => [], 'active' => 'superadmin.gym-list.*', 'icon' => 'gyms'],
            ['label' => 'Gimnasios y Suscripciones', 'route' => 'superadmin.gyms.index', 'params' => [], 'active' => 'superadmin.gyms.*|superadmin.subscriptions.*', 'icon' => 'gyms'],
