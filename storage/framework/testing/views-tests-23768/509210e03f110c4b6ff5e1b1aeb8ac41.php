...
<?php $__env->startSection('title', 'Recepcion'); ?>
<?php $__env->startSection('page-title', 'Recepcion'); ?>
...
<style>
    ...
    .reception-control-stat {
        ...
        border-radius: 1rem;
        background: linear-gradient(145deg, color-mix(in srgb, var(--card) 92%, transparent), color-mix(in srgb, var(--card-2) 68%, transparent));
    ...
    .reception-action-card {
        ...
        border-radius: 1rem;
        background: linear-gradient(150deg, color-mix(in srgb, var(--card) 92%, transparent), color-mix(in srgb, var(--card-2) 72%, transparent));
        padding: 0.8rem;
        box-shadow: 0 14px 32px -28px rgba(15, 23, 42, 0.75);
    }
    ...
    .reception-entry-panel {
        ...
        background:
            radial-gradient(circle at top right, color-mix(in srgb, var(--primary) 10%, transparent), transparent 38%),
            linear-gradient(155deg, color-mix(in srgb, var(--card) 96%, transparent), color-mix(in srgb, var(--card-2) 72%, transparent));
        padding: 0.95rem;
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => ''.e($isPlanControlReception ? 'Recepcion Control' : 'Ingreso unificado').'','subtitle' => ''.e($isPlanControlReception ? 'Acceso rapido para una sola sede, sin ruido visual.' : 'Escanea RFID/QR o escribe documento. Soporta autoenvio por lector tipo teclado.').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($isPlanControlReception ? 'Recepcion Control' : 'Ingreso unificado').'','subtitle' => ''.e($isPlanControlReception ? 'Acceso rapido para una sola sede, sin ruido visual.' : 'Escanea RFID/QR o escribe documento. Soporta autoenvio por lector tipo teclado.').'']); ?>
        <div class="reception-hero-shell">
            <div class="space-y-4">
                <div class="reception-control-copy">
                    <span class="reception-control-kicker"><?php echo e($receptionModeLabel); ?></span>
                    <h2 class="reception-control-heading"><?php echo e($receptionHeadline); ?></h2>
                    <p class="reception-control-summary"><?php echo e($receptionSummary); ?></p>
                </div>

                <?php if($isPlanControlReception): ?>
                    <div class="reception-control-stats">
                        <article class="reception-control-stat">
                            <p class="reception-control-stat-label">Accesos hoy</p>
                            <p class="reception-control-stat-value"><?php echo e($receptionTodayCount); ?></p>
                            <p class="reception-control-stat-note"><?php echo e($receptionTodayCount > 0 ? 'Ya existe movimiento registrado hoy.' : 'Listo para el primer acceso del dia.'); ?></p>
                        </article>
                        <article class="reception-control-stat">
                            <p class="reception-control-stat-label">Soporte activo</p>
                            <p class="reception-control-stat-value"><?php echo e($receptionSupportValue); ?></p>
                            <p class="reception-control-stat-note"><?php echo e($receptionSupportNote); ?></p>
                        </article>
                        <article class="reception-control-stat">
                ...
                <div class="reception-entry-panel">
                    ...
                    <div class="reception-status-row">
                        <p id="status-chip" class="inline-flex rounded-full bg-cyan-100 px-3 py-1 text-xs font-bold uppercase tracking-wide text-cyan-800 dark:bg-cyan-900/40 dark:text-cyan-200">
                            <?php echo e(__('messages.reception.ready_to_scan')); ?>
            ...
            <div class="reception-action-rail">
                <div class="reception-action-card">
                    <p class="reception-action-title"><?php echo e($isPlanControlReception ? 'Ingreso y salida' : 'Registro principal'); ?></p>
                    <div class="reception-actions-grid">
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['id' => 'send-btn','type' => 'button','variant' => 'primary','size' => 'lg','class' => 'h-14 w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'send-btn','type' => 'button','variant' => 'primary','size' => 'lg','class' => 'h-14 w-full']); ?>Registrar ingreso <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['id' => 'checkout-btn','type' => 'button','variant' => 'ghost','size' => 'lg','class' => 'h-14 w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'checkout-btn','type' => 'button','variant' => 'ghost','size' => 'lg','class' => 'h-14 w-full']); ?>
                            Registrar salida
...
<?php endif; ?>
                ...
                <div class="reception-action-card">
                    ...
                    <div class="reception-actions-grid">
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('reception.display'),'target' => '_blank','rel' => 'noopener','variant' => 'secondary','size' => 'lg','class' => 'h-14 w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('reception.display')),'target' => '_blank','rel' => 'noopener','variant' => 'secondary','size' => 'lg','class' => 'h-14 w-full']); ?>
                            Pantalla 2 + QR
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['id' => 'reception-open-mobile-scanner','type' => 'button','variant' => 'secondary','size' => 'lg','class' => 'h-14 w-full','ariaHaspopup' => 'dialog','ariaControls' => 'reception-mobile-scanner-modal','ariaExpanded' => 'false']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'reception-open-mobile-scanner','type' => 'button','variant' => 'secondary','size' => 'lg','class' => 'h-14 w-full','aria-haspopup' => 'dialog','aria-controls' => 'reception-mobile-scanner-modal','aria-expanded' => 'false']); ?>
...
<?php endif; ?>
    ...
    <?php if(!empty($canManageClientAccounts)): ?>
        <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'QR dinámico móvil','subtitle' => 'Genera QR temporal para check-in desde la PWA del cliente.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'QR dinámico móvil','subtitle' => 'Genera QR temporal para check-in desde la PWA del cliente.']); ?>
            ...
            <div id="mobile-qr-panel-content" class="reception-collapsible-content space-y-3">
                ...
                <div class="grid gap-3 md:grid-cols-[220px_auto_minmax(0,1fr)] md:items-end">
                    ...
                    <label class="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs font-bold uppercase tracking-wide text-slate-700 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200">
                        ...
                        <?php echo e(__('messages.reception.auto_rotation')); ?>

                    </label>
                    <div class="flex justify-start md:justify-end">
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['id' => 'mobile-qr-refresh','type' => 'button','variant' => 'secondary','class' => 'w-full md:w-auto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'mobile-qr-refresh','type' => 'button','variant' => 'secondary','class' => 'w-full md:w-auto']); ?>
                            Regenerar ahora
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['id' => 'result-panel','class' => 'reception-toggle-card reception-panel-expanded relative overflow-hidden border-slate-300 bg-white dark:border-slate-700 dark:bg-slate-900','title' => 'Resultado']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'result-panel','class' => 'reception-toggle-card reception-panel-expanded relative overflow-hidden border-slate-300 bg-white dark:border-slate-700 dark:bg-slate-900','title' => 'Resultado']); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Últimos 10 ingresos']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Últimos 10 ingresos']); ?>
        <div class="reception-panel-toggle-bar flex justify-end">
            ...
            <table class="ui-table min-w-[780px]">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentAttendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr data-role="recent-attendance-row"
                        data-attendance-id="<?php echo e((int) $attendance->id); ?>"
                        data-attendance-date="<?php echo e($attendance->date?->toDateString() ?? ''); ?>"
                        data-attendance-method="<?php echo e(strtolower((string) $attendanceMethod)); ?>"
                        data-attendance-client="<?php echo e(mb_strtolower((string) ($attendance->client?->full_name ?? '-'))); ?>"
                        ...
                        <td class="px-3 py-3 dark:text-slate-200"><?php echo e($attendance->date?->toDateString() ?? '-'); ?></td>
                        <td class="px-3 py-3 dark:text-slate-200"><?php echo e($attendance->time ?? '-'); ?></td>
                        <td class="px-3 py-3 font-semibold dark:text-slate-100"><?php echo e($attendance->client?->full_name ?? '-'); ?></td>
                        <td class="px-3 py-3 dark:text-slate-200"><?php echo e($attendanceMethodLabel); ?></td>
                    </tr>
            ...
            <div class="mt-4 grid gap-4 xl:grid-cols-[minmax(0,1fr)_340px]">
                ...
                <aside class="space-y-3">
                    <div class="grid gap-2 sm:grid-cols-2 xl:grid-cols-1">
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['id' => 'reception-mobile-scanner-start','type' => 'button','variant' => 'primary','class' => 'w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'reception-mobile-scanner-start','type' => 'button','variant' => 'primary','class' => 'w-full']); ?>Iniciar cámara <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['id' => 'reception-mobile-scanner-stop','type' => 'button','variant' => 'ghost','class' => 'w-full','disabled' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'reception-mobile-scanner-stop','type' => 'button','variant' => 'ghost','class' => 'w-full','disabled' => true]); ?>Detener <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                    ...
                    <div class="rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-900/70">
                        ...
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['id' => 'reception-mobile-scanner-submit','type' => 'button','variant' => 'secondary','class' => 'mt-2 w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'reception-mobile-scanner-submit','type' => 'button','variant' => 'secondary','class' => 'mt-2 w-full']); ?>
                            Procesar código
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
        ...
        <div class="ui-modal-panel max-w-6xl">
            <div class="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p class="mt-1 text-sm ui-muted">
                        Desde <?php echo e($attendanceHistoryStart); ?>.
                        <strong><?php echo e((int) ($attendanceHistoryTotal ?? 0)); ?></strong> registros en ventana operativa.
                    </p>
                </div>
                <button type="button" class="ui-button ui-button-ghost px-2 py-1" data-close-attendance-history aria-label="Cerrar">X</button>
            </div>

            <?php if(!empty($attendanceHistoryTruncated)): ?>
            ...
            <div class="mt-4 overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-700">
                <table class="ui-table min-w-[980px]">
                    ...
                    <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = ($attendanceHistory ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        <tr class="border-b border-slate-100 text-sm odd:bg-white even:bg-slate-50 dark:border-slate-800 dark:odd:bg-slate-900 dark:even:bg-slate-950/50">
                            <td class="px-3 py-3 dark:text-slate-200"><?php echo e($row->date?->toDateString() ?? '-'); ?></td>
                            <td class="px-3 py-3 dark:text-slate-200"><?php echo e($row->time ?? '-'); ?></td>
                            <td class="px-3 py-3 font-semibold dark:text-slate-100"><?php echo e($row->client?->full_name ?? '-'); ?></td>
                            <td class="px-3 py-3 dark:text-slate-200"><?php echo e($historyMethodLabel); ?></td>
                            <td class="px-3 py-3 dark:text-slate-200"><?php echo e($row->createdBy?->name ?? '-'); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
...
<script>
    (function () {
        ...
        const syncGymName = String(<?php echo json_encode((string) $syncGymName, 15, 512) ?>);
        const syncGymId = Number(<?php echo json_encode((int) $syncGymId, 15, 512) ?>);
        const gymAvatarUrls = <?php echo json_encode($gymAvatarUrls, 15, 512) ?>;
        const mobileQrEndpoint = <?php echo json_encode(route('reception.mobile-qr'), 15, 512) ?>;
        const mobileQrStatusEndpoint = <?php echo json_encode(route('reception.mobile-qr.status'), 15, 512) ?>;
        const syncPollUrl = <?php echo json_encode(route('reception.sync.latest'), 15, 512) ?>;
        ...
        const autoOpenMobileScannerModal = Boolean(<?php echo json_encode(request()->boolean('open_mobile_scanner'), 15, 512) ?>);
        const latestSyncEventId = String(<?php echo json_encode((string) ($latestSyncEventId ?? ''), 15, 512) ?>);
        const latestSyncEventPublishedAt = Number(<?php echo json_encode((int) ($latestSyncEventPublishedAt ?? 0), 15, 512) ?>) || 0;
        ...
        const receptionI18n = {
            ready_to_scan: <?php echo json_encode(__('messages.reception.ready_to_scan'), 15, 512) ?>,
            invalid_server_response: <?php echo json_encode(__('messages.reception.invalid_server_response'), 15, 512) ?>,
            qr_update_failed: <?php echo json_encode(__('messages.reception.qr_update_failed'), 15, 512) ?>,
            network_retry: <?php echo json_encode(__('messages.reception.network_retry'), 15, 512) ?>,
            processing: <?php echo json_encode(__('messages.reception.processing'), 15, 512) ?>,
            processing_checkout: <?php echo json_encode(__('messages.reception.processing_checkout'), 15, 512) ?>,
            register_checkout: <?php echo json_encode(__('messages.reception.register_checkout'), 15, 512) ?>,
        };
        const methodLabels = {
            rfid: 'RFID',
            qr: 'QR',
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\gymsystem\resources\views/reception/index.blade.php ENDPATH**/ ?>