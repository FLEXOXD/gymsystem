...
.plans-page .plans-control-shell {
    ...
    background:
        ...
        linear-gradient(150deg, rgb(255 255 255 / .98), rgb(248 250 252 / .95));
    box-shadow: 0 22px 42px -34px rgb(15 23 42 / .5);
    padding: 1rem;
}
.theme-dark .plans-page .plans-control-shell {
    border-color: rgb(163 230 53 / .24);
    background:
        radial-gradient(circle at top right, rgb(163 230 53 / .12), transparent 34%),
        linear-gradient(160deg, rgb(2 6 23 / .84), rgb(15 23 42 / .62));
    box-shadow: 0 24px 46px -34px rgb(2 8 23 / .92);
}
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('clients.index'),'variant' => ''.e($isReadOnlyScope ? 'primary' : 'secondary').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('clients.index')),'variant' => ''.e($isReadOnlyScope ? 'primary' : 'secondary').'']); ?>Ir a clientes <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Crear plan','subtitle' => 'Modo de solo lectura.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Crear plan','subtitle' => 'Modo de solo lectura.']); ?>
...
<?php endif; ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="<?php echo e($isGlobalScope ? 7 : 6); ?>" class="px-4 py-8 text-center text-sm font-semibold text-slate-400">No hay planes registrados.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
...
<?php endif; ?>
    ...
    <div id="promotion-create-modal" class="modal-shell" aria-hidden="true" aria-labelledby="promotion-create-title">
        <div class="modal-card">
            ...
            <form id="promotion-form" method="POST" action="<?php echo e(route('plans.promotions.store')); ?>" class="space-y-4 px-4 py-4">
                <?php echo csrf_field(); ?>
