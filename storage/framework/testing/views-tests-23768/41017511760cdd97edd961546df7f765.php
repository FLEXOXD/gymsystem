    ...
    <style>
        ...
        .client-control-shell {
            ...
            background:
                ...
                linear-gradient(152deg, rgb(255 255 255 / 0.98), rgb(248 250 252 / 0.96));
            box-shadow: 0 20px 40px -32px rgb(15 23 42 / 0.48);
            padding: 1rem;
        }
        ...
        .theme-dark .client-control-shell {
            ...
            box-shadow: 0 22px 42px -30px rgb(2 8 23 / 0.92);
        }
