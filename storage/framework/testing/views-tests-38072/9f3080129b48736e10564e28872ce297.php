    ...
    <div class="quote-modal-shell">
        <section class="quote-modal-side">
            <div class="quote-modal-brand">
                <?php if($quoteModalBrandLogoUrl !== ''): ?>
                    <span class="quote-modal-brand-logo-wrap">
                        <img src="<?php echo e($quoteModalBrandLogoUrl); ?>" alt="<?php echo e($brandName); ?>" class="quote-modal-brand-logo">
                    </span>
                <?php else: ?>
                    <span class="quote-modal-brand-mark"><?php echo e($brandInitials); ?></span>
                <?php endif; ?>

                <div>
                    <strong class="quote-modal-brand-name"><?php echo e($brandName); ?></strong>
            ...
            <div class="quote-modal-photo-frame"
                 <?php if($quoteVisualImage !== ''): ?>
                     style="background-image: linear-gradient(180deg, rgba(7, 17, 31, 0.12), rgba(7, 17, 31, 0.74)), url('<?php echo e($quoteVisualImage); ?>');"
                 <?php endif; ?>
                 aria-hidden="true">
                ...
                <article class="quote-modal-plan-spotlight">
                    ...
                    <strong data-quote-plan-label data-default-label="<?php echo e($quoteDefaultPlanLabel); ?>"><?php echo e($quoteCurrentPlanLabel); ?></strong>
                    <p data-quote-plan-copy data-default-copy="<?php echo e($quoteDefaultPlanCopy); ?>"><?php echo e($quoteCurrentPlanCopy); ?></p>
                </article>
            </div>
        ...
        <section class="quote-modal-form-panel">
            <header class="quote-form-header">
                ...
                <h3 id="quote-request-title"
                    ...
                    data-default="<?php echo e($quoteDefaultFormTitle); ?>"><?php echo e($quoteFormTitleText); ?></h3>
                <p data-quote-form-copy data-default="<?php echo e($quoteDefaultFormCopy); ?>"><?php echo e($quoteFormCopyText); ?></p>
            </header>
            ...
            <div id="quote-plan-pill" class="quote-plan-pill <?php echo e($quoteSelectedPlanKey !== '' ? 'is-visible' : ''); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <button type="submit"
                        ...
                        data-default="<?php echo e($quoteDefaultSubmitLabel); ?>"><?php echo e($quoteSubmitLabelText); ?></button>
            </form>
        </section>
    </div>
</div>
