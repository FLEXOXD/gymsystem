    ...
    <div class="premium-hero-layout">
        <div class="premium-hero-copy reveal" style="--reveal-delay: 180ms; --reveal-distance: 28px; --reveal-duration: .95s;">
            ...
            <h1 class="premium-hero-title">
                <?php $__currentLoopData = $premiumHeroTitleLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
