...
<?php
    $serviceCards = [
        [
            ...
            'items' => [
                trim((string) ($content['section_1_item_1'] ?? 'Ingreso y registro de acceso con QR, RFID, pulseras y llaveros')),
    ...
    $heroProofItems = [
        ...
        ['title' => 'Recepción más rápida', 'text' => 'Registro de acceso con flujo claro para escritorio, tableta y móvil.'],
        ['title' => 'Listo para crecer', 'text' => 'Desde una sede hasta una operación multisede sin cambiar de sistema.'],
    ];
    ...
    $outcomeCards = [
        [
            ...
            'text' => 'Registro de acceso, membresías y cobros quedan a mano para atender mejor y perder menos tiempo.',
            'metric' => 'Menos filas',
        ],
        [
            'eyebrow' => 'Control',
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e($tabIconSmallUrl); ?>">
    <link rel="shortcut icon" href="<?php echo e($tabIconUrl); ?>">
    <link rel="apple-touch-icon" href="<?php echo e($tabTouchIconUrl); ?>">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .mobile-nav-links a.is-active {
            color: #d9ff63;
            border-color: rgba(213, 255, 90, 0.94);
            background: linear-gradient(180deg, rgba(14, 18, 12, 0.96), rgba(10, 12, 10, 0.94));
            box-shadow:
                0 0 0 1px rgba(213, 255, 90, 0.16),
                0 0 18px rgba(185, 255, 31, 0.12);
            text-shadow:
                0 0 10px rgba(217, 255, 99, 0.24);
        }
        .mobile-nav-actions {
            margin-top: .7rem;
            display: grid;
        ...
        <?php echo $__env->make('marketing.partials.about-premium-styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('marketing.partials.contact-premium-styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        .legal-shell {
            margin-top: 1.1rem;
            border: 1px solid #2b5a40;
            border-radius: 1rem;
        ...
        .reveal {
            opacity: 0;
            transform: translate3d(0, var(--reveal-distance, 18px), 0) scale(var(--reveal-scale-start, .992));
            filter: blur(var(--reveal-blur, 1.4px));
            transition:
                opacity var(--reveal-duration, .72s) cubic-bezier(.22, 1, .36, 1),
                transform var(--reveal-duration, .72s) cubic-bezier(.22, 1, .36, 1),
                filter var(--reveal-duration, .72s) ease;
    ...
    <?php echo $__env->make('marketing.partials.home-premium-styles', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <style>
        .shell {
        ...
        .top-wrap .mobile-nav-links a.is-active {
            color: #d8ff63 !important;
            -webkit-text-fill-color: #d8ff63;
            background: linear-gradient(180deg, rgba(14, 18, 12, .96), rgba(10, 12, 10, .94));
            border-color: rgba(216, 255, 99, .9);
            box-shadow:
                0 0 0 1px rgba(216, 255, 99, .16),
                0 0 18px rgba(216, 255, 99, .12);
            text-shadow: 0 0 10px rgba(216, 255, 99, .24);
            transform: none;
        }
...
<body class="<?php echo e($showPrimarySections ? 'is-home' : 'is-subpage'); ?>">
    ...
    <header class="top-wrap page-intro-item" style="--page-intro-delay: 70ms; --page-intro-distance: 20px;" data-intro-axis="top">
        <div class="shell">
            <nav class="top-nav">
                <a class="brand" href="<?php echo e(route('landing')); ?>" aria-label="<?php echo e($brandName); ?>">
            ...
            <div id="landing-mobile-nav" class="mobile-nav-panel" data-mobile-nav-panel hidden>
                <div class="mobile-nav-header">
                    <div class="mobile-nav-brand">
                        <a class="mobile-nav-brand-link" href="<?php echo e(route('landing')); ?>" aria-label="<?php echo e($brandName); ?>">
                            <span class="mobile-nav-brand-stage">
                                <?php if($brandLogoUrl !== ''): ?>
                                    <img src="<?php echo e($brandLogoUrl); ?>" alt="<?php echo e($brandName); ?>" class="mobile-nav-brand-logo">
                                <?php else: ?>
                                    <span class="brand-fallback"><?php echo e($brandInitials); ?></span>
                                <?php endif; ?>
                            </span>
    ...
    <main class="main">
        ...
        <?php if($showPrimarySections): ?>
            <?php echo $__env->make('marketing.partials.home-premium', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>

        <?php if(false && $showPrimarySections): ?>
        <section id="inicio" class="shell hero">
            ...
            <div class="reveal">
                ...
                <h1>
                    <?php echo e($heroTitleText); ?>

                    <?php if (! ($heroHasClosingPhrase)): ?>
                ...
                <div class="hero-proof-strip">
                    <?php $__currentLoopData = $heroProofItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="hero-proof-card">
                            <p class="hero-proof-title"><?php echo e($item['title']); ?></p>
                            <p class="hero-proof-copy"><?php echo e($item['text']); ?></p>
                        </article>
        ...
        <section class="shell outcome-band">
            ...
            <div class="outcome-grid">
                <?php $__currentLoopData = $outcomeCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outcome): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="outcome-card reveal">
                        <small><?php echo e($outcome['eyebrow']); ?></small>
                        <h3><?php echo e($outcome['title']); ?></h3>
                        <p><?php echo e($outcome['text']); ?></p>
                        <span class="outcome-metric"><?php echo e($outcome['metric']); ?></span>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </section>
        ...
        <section class="shell section">
            ...
            <div class="workflow-grid">
                <?php $__currentLoopData = $journeySteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $journeyStep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="workflow-card reveal">
                        <span class="workflow-step"><?php echo e($journeyStep['step']); ?></span>
                        <h3><?php echo e($journeyStep['title']); ?></h3>
                        <p><?php echo e($journeyStep['text']); ?></p>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </section>
                    ...
                    <article class="plan reveal <?php echo e($isFeatured ? 'popular' : ''); ?>">
                        ...
                        <?php if($isContactMode): ?>
                            ...
                            <div class="plan-discount">
                                ...
                                <span class="plan-discount-detail">
                                    ...
                                    <?php elseif($discountPercent !== null && $discountPercent > 0): ?>
                        ...
                        <div class="plan-meta-grid">
                            <article class="plan-meta-item">
                                ...
                                <span><?php echo e($planCard['ideal_for'] ?? 'Operación en crecimiento.'); ?></span>
                            </article>
                            <article class="plan-meta-item">
                                <strong>Lo que más te ayuda</strong>
                                <span><?php echo e($planCard['ops_focus'] ?? 'Control operativo.'); ?></span>
                            </article>
                            <article class="plan-meta-item">
                                <strong>Cómo empiezas</strong>
                                <span><?php echo e($planCard['setup_note'] ?? 'Configuración según necesidad.'); ?></span>
                            </article>
                        </div>
                        <ul>
                            <?php $__currentLoopData = $planFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    ...
                                    $featureDisplay = $isHighlightedFeature
                                        ...
                                        : $featureText;
                                ?>
                                <li class="<?php echo e($isHighlightedFeature ? 'plan-highlight' : ''); ?>">
                                    <?php if($isHighlightedFeature): ?>
                                        <span class="plan-highlight-tag">Incluido</span>
                                    <?php endif; ?>
                                    <span><?php echo e($featureDisplay); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                        <div class="plan-cta">
                            <button class="btn btn-quote-trigger <?php echo e($isContactMode ? 'btn-wa' : ($isFeatured ? 'btn-demo' : 'btn-outline')); ?>"
                                    type="button"
        ...
        <section class="shell cta-band reveal">
            ...
            <div class="cta-band-actions">
                ...
                <a href="<?php echo e($contactHref); ?>" class="btn btn-ghost">Ir a contacto</a>
            </div>
        </section>
        <?php endif; ?>

        <?php if($showAboutSection): ?>
        <?php echo $__env->make('marketing.partials.about-premium', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
        ...
        ?>
        <?php echo $__env->make('marketing.partials.contact-premium', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php endif; ?>
    ...
    <footer class="footer">
        <div class="shell footer-panel">
            <div class="footer-grid" data-reveal-group data-reveal-step="90">
            ...
            <section class="footer-nav-column">
                ...
                <ul>
                    <li><a href="<?php echo e($content['whatsapp_url']); ?>" target="_blank" rel="noreferrer">Atención comercial por WhatsApp</a></li>
    ...
    <?php echo $__env->make('marketing.partials.quote-request-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div id="demo-limit-modal"
        ...
        <h4 id="demo-limit-title">Límite de demos alcanzado</h4>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.support-chat.widget','data' => ['context' => 'landing','stateUrl' => route('support-chat.landing.state'),'restartUrl' => route('support-chat.landing.restart'),'quickReplyUrl' => route('support-chat.landing.quick-reply'),'messageUrl' => route('support-chat.landing.message'),'csrfToken' => csrf_token(),'gymName' => $brandName,'gymLogoUrl' => $brandLogoUrl,'leadCapture' => true,'launcherTitle' => 'Soporte para gimnasios']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['context' => 'landing','state-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('support-chat.landing.state')),'restart-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('support-chat.landing.restart')),'quick-reply-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('support-chat.landing.quick-reply')),'message-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('support-chat.landing.message')),'csrf-token' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(csrf_token()),'gym-name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($brandName),'gym-logo-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($brandLogoUrl),'lead-capture' => true,'launcher-title' => 'Soporte para gimnasios']); ?>
        ...
        (function () {
            ...
            const prepareRevealGroups = function () {
                ...
                groups.forEach(function (group) {
                    const selector = (group.getAttribute('data-reveal-selector') || '').trim();
                    const baseDelay = parseInt(group.getAttribute('data-reveal-delay') || '0', 10);
                    const stepDelay = parseInt(group.getAttribute('data-reveal-step') || '85', 10);
                    ...
                    items = items.filter(function (item) {
                        ...
                        if (selector !== '' && item.closest('[data-reveal-group]') !== group) {
                            return false;
                        }
                    ...
                    items.forEach(function (item, index) {
                        ...
                        if (!item.style.getPropertyValue('--reveal-delay')) {
                            const delay = baseDelay + (Math.min(index, 7) * stepDelay);
                            item.style.setProperty('--reveal-delay', delay + 'ms');
                        }

                        if (item.tagName === 'LI' && !item.style.getPropertyValue('--reveal-distance')) {
                            item.style.setProperty('--reveal-distance', '10px');
                        }
                    });
                });
            };
            ...
            if (mobileMenuToggle && mobileNavPanel) {
                const setMobileMenuState = function (open) {
                    ...
                    if (open) {
                        ...
                        if (mobileNavBackdrop) {
                            mobileNavBackdrop.setAttribute('hidden', 'hidden');
                        }
                    }
                };
            ...
            const openFaqItem = function (targetItem) {
                faqItems.forEach(function (other) {
                    const otherButton = other.querySelector('[data-faq-button]');
                    const isTarget = other === targetItem;
            ...
            const syncFaqWithHash = function () {
                const hash = String(window.location.hash || '').trim();
                if (hash === '' || hash === '#') {
                    return;
                }

                const targetItem = document.querySelector(hash + '[data-faq-item]');
                if (!targetItem) {
                    return;
                }
            ...
            const interfaceModal = document.getElementById('interface-detail-modal');
            const interfaceBackdrop = document.getElementById('interface-detail-backdrop');
            const interfaceCloseButton = document.getElementById('interface-detail-close');
            const interfaceTriggers = Array.from(document.querySelectorAll('[data-interface-modal-open]'));
            const interfaceModalBadge = document.getElementById('interface-modal-badge');
            const interfaceModalTitle = document.getElementById('interface-modal-title');
            const interfaceModalText = document.getElementById('interface-modal-text');
            const interfaceModalList = document.getElementById('interface-modal-list');
            const interfaceModalImage = document.getElementById('interface-modal-image');
            const interfaceModalPrimaryAction = document.getElementById('interface-modal-primary-action');
            const interfaceModalDemoForm = document.getElementById('interface-modal-demo-form');
            const interfaceModalNote = document.getElementById('interface-modal-note');
            let activeInterfaceTrigger = null;
            const interfaceModalQueryParam = 'interface';

            const replaceInterfaceQueryParam = function (value) {
                ...
                if (value && value.trim() !== '') {
                    currentUrl.searchParams.set(interfaceModalQueryParam, value.trim());
                } else {
                    currentUrl.searchParams.delete(interfaceModalQueryParam);
                }

                window.history.replaceState({}, '', currentUrl.toString());
            };

            const closeInterfaceModal = function () {
                if (!(interfaceModal instanceof HTMLElement) || !(interfaceBackdrop instanceof HTMLElement)) {
                    return;
                }

                interfaceModal.hidden = true;
                interfaceBackdrop.hidden = true;
                interfaceModal.setAttribute('aria-hidden', 'true');
                replaceInterfaceQueryParam('');
                syncLandingModalBodyState();

                if (activeInterfaceTrigger instanceof HTMLElement) {
                    activeInterfaceTrigger.focus();
                }
            };

            const openInterfaceModal = function (trigger, options = {}) {
                if (
                    !(trigger instanceof HTMLElement)
                    || !(interfaceModal instanceof HTMLElement)
                    || !(interfaceBackdrop instanceof HTMLElement)
                ) {
                    return;
                }

                activeInterfaceTrigger = trigger;
                const badge = String(trigger.getAttribute('data-modal-badge') || '').trim();
                const title = String(trigger.getAttribute('data-modal-title') || '').trim();
                const text = String(trigger.getAttribute('data-modal-text') || '').trim();
                const image = String(trigger.getAttribute('data-modal-image') || '').trim();
                const modalKey = String(trigger.getAttribute('data-modal-key') || '').trim();
                const actionMode = String(trigger.getAttribute('data-modal-action-mode') || 'demo').trim();
                const actionLabel = String(trigger.getAttribute('data-modal-action-label') || 'Probar demo gratis').trim();
                const actionHref = String(trigger.getAttribute('data-modal-action-href') || '').trim();
                const modalNote = String(trigger.getAttribute('data-modal-note') || '').trim();
                let items = [];

                try {
                    items = JSON.parse(String(trigger.getAttribute('data-modal-items') || '[]'));
                } catch (error) {
                    items = [];
                }

                if (interfaceModalBadge instanceof HTMLElement) {
                    interfaceModalBadge.textContent = badge !== '' ? badge : 'Interfaz destacada';
                }

                if (interfaceModalTitle instanceof HTMLElement) {
                    interfaceModalTitle.textContent = title !== '' ? title : 'Detalle de la interfaz';
                }

                if (interfaceModalText instanceof HTMLElement) {
                    interfaceModalText.textContent = text !== '' ? text : 'Explicacion breve de la interfaz seleccionada.';
                }

                if (interfaceModalPrimaryAction instanceof HTMLButtonElement) {
                    interfaceModalPrimaryAction.textContent = actionLabel !== '' ? actionLabel : 'Probar demo gratis';
                    interfaceModalPrimaryAction.dataset.actionMode = actionMode !== '' ? actionMode : 'demo';
                    interfaceModalPrimaryAction.dataset.actionHref = actionHref;
                }

                if (interfaceModalList instanceof HTMLElement) {
                    interfaceModalList.innerHTML = '';
                    ...
                    validItems.forEach(function (item) {
                            ...
                            interfaceModalList.appendChild(listItem);
                        });
                    interfaceModalList.hidden = validItems.length === 0;
                }

                if (interfaceModalImage instanceof HTMLImageElement) {
                    interfaceModalImage.src = image;
                    interfaceModalImage.alt = title !== '' ? title : 'Interfaz principal';
                }

                if (interfaceModalNote instanceof HTMLElement) {
                    interfaceModalNote.textContent = modalNote !== '' ? modalNote : 'Se abre un entorno temporal con datos de ejemplo para revisar el flujo sin afectar cuentas reales.';
                    interfaceModalNote.hidden = interfaceModalNote.textContent.trim() === '';
                }

                if (options.syncUrl !== false && modalKey !== '') {
                    replaceInterfaceQueryParam(modalKey);
                }

                interfaceModal.hidden = false;
                interfaceBackdrop.hidden = false;
                interfaceModal.setAttribute('aria-hidden', 'false');
                syncLandingModalBodyState();
            };

            interfaceTriggers.forEach(function (trigger) {
                trigger.addEventListener('click', function () {
                    openInterfaceModal(trigger);
                });
            });

            if (interfaceModalPrimaryAction instanceof HTMLButtonElement) {
                interfaceModalPrimaryAction.addEventListener('click', function () {
                    const mode = String(interfaceModalPrimaryAction.dataset.actionMode || 'demo').trim();
                    const href = String(interfaceModalPrimaryAction.dataset.actionHref || '').trim();
                    ...
                    if (interfaceModalDemoForm instanceof HTMLFormElement) {
                        if (typeof interfaceModalDemoForm.requestSubmit === 'function') {
                            interfaceModalDemoForm.requestSubmit();
                            return;
                        }

                        interfaceModalDemoForm.submit();
                    }
                });
            }

            if (interfaceCloseButton instanceof HTMLElement) {
                interfaceCloseButton.addEventListener('click', closeInterfaceModal);
            }

            if (interfaceBackdrop instanceof HTMLElement) {
                interfaceBackdrop.addEventListener('click', closeInterfaceModal);
            }

            const interfaceQueryValue = String(new URL(window.location.href).searchParams.get(interfaceModalQueryParam) || '').trim();
            if (interfaceQueryValue !== '') {
                const matchedTrigger = interfaceTriggers.find(function (trigger) {
                    return String(trigger.getAttribute('data-modal-key') || '').trim() === interfaceQueryValue;
                });

                if (matchedTrigger instanceof HTMLElement) {
                    openInterfaceModal(matchedTrigger, { syncUrl: false });
                }
            }
            ...
            const quotePlanLabels = quoteModal ? Array.from(quoteModal.querySelectorAll('[data-quote-plan-label]')) : [];
            const quotePlanCopies = quoteModal ? Array.from(quoteModal.querySelectorAll('[data-quote-plan-copy]')) : [];
            const quoteFormTitle = quoteModal ? quoteModal.querySelector('[data-quote-form-title]') : null;
            const quoteFormCopy = quoteModal ? quoteModal.querySelector('[data-quote-form-copy]') : null;
            const quoteSubmitLabel = quoteForm ? quoteForm.querySelector('[data-quote-submit-label]') : null;
            ...
            const readQuoteDefaultText = function (element, attributeName, fallback) {
            ...
            const defaultQuoteLabel = quotePlanLabels.length > 0
                ? readQuoteDefaultText(quotePlanLabels[0], 'data-default-label', 'Cotización general')
                : 'Cotización general';
            const defaultQuoteCopy = quotePlanCopies.length > 0
                ? readQuoteDefaultText(quotePlanCopies[0], 'data-default-copy', 'Te ayudamos a elegir el plan correcto según tu tamaño, operación y metas comerciales.')
                : 'Te ayudamos a elegir el plan correcto según tu tamaño, operación y metas comerciales.';
            const defaultQuoteFormTitle = readQuoteDefaultText(
                quoteFormTitle,
                'data-default',
                'Completa el formulario y recibe tu cotización personalizada',
            );
            const defaultQuoteFormCopy = readQuoteDefaultText(
                quoteFormCopy,
                'data-default',
                'Cuéntanos cómo opera tu gimnasio hoy y te responderemos con una propuesta clara para tu negocio.',
            );
            const defaultQuoteSubmitLabel = readQuoteDefaultText(
                quoteSubmitLabel,
                'data-default',
                'Solicitar cotización personalizada',
            );
            const quotePlanCatalog = quoteTriggers.reduce(function (catalog, trigger) {
                const key = String(trigger.getAttribute('data-quote-plan') || '').trim();
                ...
                catalog[key] = {
                    label: String(trigger.getAttribute('data-quote-plan-name') || '').trim(),
                    summary: String(
                        trigger.getAttribute('data-quote-plan-summary')
                        || trigger.getAttribute('data-quote-plan-ideal')
                        || ''
                    ).trim(),
                };
            ...
            function syncLandingModalBodyState() {
                const interfaceOpen = interfaceModal instanceof HTMLElement && !interfaceModal.hidden;
                const quoteOpen = quoteModal instanceof HTMLElement && quoteModal.classList.contains('is-open');

                if (interfaceOpen || quoteOpen) {
            ...
            const setQuoteText = function (nodes, value) {
            ...
            const syncQuotePlan = function (value, metadata) {
                ...
                if (normalized === '') {
                    ...
                    setQuoteText(quotePlanLabels, defaultQuoteLabel);
                    setQuoteText(quotePlanCopies, defaultQuoteCopy);

                    if (quoteFormTitle instanceof HTMLElement) {
                        quoteFormTitle.textContent = defaultQuoteFormTitle;
                    }

                    if (quoteFormCopy instanceof HTMLElement) {
                        quoteFormCopy.textContent = defaultQuoteFormCopy;
                    }

                    if (quoteSubmitLabel instanceof HTMLElement) {
                        quoteSubmitLabel.textContent = defaultQuoteSubmitLabel;
                    }

                    return;
                }

                const planMetadata = Object.prototype.hasOwnProperty.call(quotePlanCatalog, normalized)
                    ? quotePlanCatalog[normalized]
                    : {};
                const resolvedLabel = String(
                    metadata && Object.prototype.hasOwnProperty.call(metadata, 'label')
                        ? metadata.label
                        : (planMetadata.label || '')
                ).trim() || humanizeQuotePlan(normalized);
                const resolvedSummary = String(
                    metadata && Object.prototype.hasOwnProperty.call(metadata, 'summary')
                        ? metadata.summary
                ...
                setQuoteText(quotePlanLabels, resolvedLabel);
                setQuoteText(
                    quotePlanCopies,
                    resolvedSummary !== ''
                        ? resolvedSummary
                        : 'Te contactaremos con una propuesta enfocada en ' + resolvedLabel + '.',
                );

                if (quoteFormTitle instanceof HTMLElement) {
                    quoteFormTitle.textContent = 'Solicita la cotización de ' + resolvedLabel;
                }

                if (quoteFormCopy instanceof HTMLElement) {
                    quoteFormCopy.textContent = 'Completa tus datos y te contactaremos con una propuesta enfocada en '
                        + resolvedLabel
                        + ' y la operación real de tu gimnasio.';
                }

                if (quoteSubmitLabel instanceof HTMLElement) {
                    quoteSubmitLabel.textContent = 'Solicitar cotización de ' + resolvedLabel;
                }
            };
            ...
            const openQuoteModal = function (options) {
                ...
                const source = options && Object.prototype.hasOwnProperty.call(options, 'source')
                    ? options.source
                    : '';
                const label = options && Object.prototype.hasOwnProperty.call(options, 'label')
                    ? options.label
                    : '';
                const summary = options && Object.prototype.hasOwnProperty.call(options, 'summary')
                    ? options.summary
                    : '';
            ...
            quoteTriggers.forEach(function (trigger) {
                trigger.addEventListener('click', function (event) {
                    ...
                    openQuoteModal({
                        ...
                        label: trigger.getAttribute('data-quote-plan-name') || '',
                        summary: trigger.getAttribute('data-quote-plan-summary') || trigger.getAttribute('data-quote-plan-ideal') || '',
            ...
            document.addEventListener('keydown', function (event) {
                if (event.key === 'Escape' && interfaceModal && !interfaceModal.hidden) {
                    closeInterfaceModal();
                    return;
                }
            ...
            if (quoteForm) {
                quoteForm.addEventListener('submit', function () {
                    ...
                    if (submitButton instanceof HTMLButtonElement) {
                        ...
                        submitButton.textContent = 'Enviando tu solicitud...';
                    }
                });
            }
