            ...
            <div id="products-ops-modal" class="ui-modal-backdrop <?php echo e($productModalOpen || $stockModalOpen ? '' : 'hidden'); ?>" role="dialog" aria-modal="true" aria-labelledby="products-ops-modal-title" aria-hidden="<?php echo e($productModalOpen || $stockModalOpen ? 'false' : 'true'); ?>">
                <div class="ui-modal-shell w-full max-w-6xl" data-products-ops-dialog tabindex="-1">
                    ...
                    <div class="ui-modal-scroll-body px-5 py-5">
                        <section id="products-ops-grid" class="products-ops-grid grid gap-4 xl:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)]" data-view="<?php echo e($productModalOpen ? 'product' : ($stockModalOpen ? 'stock' : 'product')); ?>">
                            <div data-products-panel="product" <?php if($stockModalOpen && ! $productModalOpen): ?> hidden <?php endif; ?>>
                                <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => $editingProduct ? 'Editar producto' : 'Registrar producto','subtitle' => 'Define precio, costo, categoria y stock minimo del producto.','class' => 'products-surface-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($editingProduct ? 'Editar producto' : 'Registrar producto'),'subtitle' => 'Define precio, costo, categoria y stock minimo del producto.','class' => 'products-surface-card']); ?>
...
<?php endif; ?>
                            ...
                            <div data-products-panel="stock" <?php if($productModalOpen && ! $stockModalOpen): ?> hidden <?php endif; ?>>
                                <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
