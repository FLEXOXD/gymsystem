<?php
    ...
    $contactLocation = 'Machachi, cantón Mejía, Pichincha, Ecuador';
    $contactHours = 'De 9:00 a. m. a 7:00 p. m.';
        ...
        <div class="contact-simple-grid">
            <div class="contact-simple-copy reveal">
                ...
                <p class="contact-simple-text">
                    Escríbenos y con gusto te ayudamos con información, reservas o cualquier consulta.
                </p>

                <div class="contact-simple-actions" data-reveal-group data-reveal-step="95">
                ...
                <div class="contact-detail-grid" aria-label="Datos de contacto" data-reveal-group data-reveal-step="90" data-reveal-delay="60">
            ...
            <section class="contact-form-card reveal">
                ...
                <form id="landing-contact-form"
                      ...
                      data-reveal-group
                      data-reveal-selector=".contact-form-field, .contact-submit"
                      data-reveal-step="85"
                      method="POST"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="contact-submit">
                        ...
                        <p class="contact-submit-note">Tu información se usará solo para responder esta solicitud.</p>
                    </div>
                </form>
            </section>
        </div>
