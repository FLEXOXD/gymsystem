<?php $__env->startSection('title', 'SuperAdmin Planes'); ?>
<?php $__env->startSection('page-title', 'Planes base y promociones'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('superadmin.web-page.edit')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('superadmin.web-page.edit'))]); ?>Editar landing <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('landing', ['preview_guest' => 1]),'variant' => 'secondary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('landing', ['preview_guest' => 1])),'variant' => 'secondary']); ?>Ver pagina publica <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                ...
                <aside class="sa-note-card">
                    ...
                    <div class="sa-note-list">
                        <div class="sa-note-item">
                            <strong>Base</strong>
                            <span><?php echo e($basePlans->count()); ?> slots base conectados con la landing.</span>
                        </div>
                        <div class="sa-note-item">
                            <strong>Planes base</strong>
                            <span><?php echo e($activeBasePlans); ?> activos con precio editable.</span>
                        </div>
                        <div class="sa-note-item">
        ...
        <section class="sa-stat-grid">
            <article class="sa-stat-card is-neutral">
                ...
                <p class="sa-stat-value"><?php echo e($basePlans->count()); ?></p>
            ...
            <article class="sa-stat-card is-success">
                ...
                <p class="sa-stat-value"><?php echo e($plansWithPromotions); ?></p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Planes base conectados con la landing','subtitle' => 'Aqui mantienes el precio base de cada plan y ves si tiene una promoción activa.','class' => 'sa-form-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Planes base conectados con la landing','subtitle' => 'Aqui mantienes el precio base de cada plan y ves si tiene una promoción activa.','class' => 'sa-form-card']); ?>
            <?php if(! $schemaReady): ?>
            ...
            <div class="grid gap-4 lg:grid-cols-2">
                <?php $__currentLoopData = $basePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <article class="sa-form-panel is-solid">
                        <div class="flex flex-wrap items-center gap-2">
                            <span class="sa-pill <?php echo e($isActive ? 'is-success' : 'is-neutral'); ?>"><?php echo e($isActive ? 'Activo' : 'Inactivo'); ?></span>
                            <span class="sa-pill is-info">Base funcional</span>
                        </div>

                        <h3 class="mt-4 text-xl font-black text-slate-900 dark:text-slate-100"><?php echo e($plan->name); ?></h3>
                        <p class="mt-1 text-sm text-slate-600 dark:text-slate-300"><?php echo e((string) ($meta['summary'] ?? 'Plan base disponible para tu operacion.')); ?></p>
                        ...
                        <div class="mt-4 grid gap-3 md:grid-cols-2">
                            <div class="rounded-2xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/50">
                                ...
                                <p class="mt-1 font-semibold text-slate-900 dark:text-slate-100"><?php echo e(\App\Support\PlanDuration::label($plan->duration_unit, (int) $plan->duration_days, $plan->duration_months)); ?></p>
                            </div>
                            <div class="rounded-2xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/50">
                                <p class="text-[11px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">Precio base</p>
                                <p class="mt-1 font-semibold text-slate-900 dark:text-slate-100"><?php echo e(\App\Support\Currency::format((float) $plan->price, $appCurrencyCode ?? 'USD')); ?></p>
                            </div>
                        </div>

                        <form method="POST" action="<?php echo e($schemaReady ? route('superadmin.plan-templates.pricing.update', $plan->id) : '#'); ?>" class="mt-5 grid gap-3">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>

                            <div class="sa-form-panel text-xs leading-6 text-slate-600 dark:text-slate-300">
                                <?php if($activePromotion): ?>
                                    Promocion activa: <strong><?php echo e($activePromotion->name); ?></strong>.
                                    <?php echo e(trim((string) ($activePromotion->description ?? '')) !== '' ? $activePromotion->description : 'La landing y el cobro mostraran esta oferta automaticamente cuando aplique.'); ?>

                                <?php elseif(trim((string) ($plan->offer_text ?? '')) !== ''): ?>
                                    Oferta manual activa: <strong><?php echo e($plan->offer_text); ?></strong>.
                            ...
                            <label class="space-y-1 text-[11px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">
                                Precio base mensual
                                <input type="number" step="0.01" min="0" name="price" class="ui-input" value="<?php echo e(number_format((float) $plan->price, 2, '.', '')); ?>" required>
                            </label>
                            ...
                            <label class="space-y-1 text-[11px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">
                                ...
                                <input type="text"
                                       ...
                                       maxlength="255"
                                       class="ui-input"
                                       value="<?php echo e(trim((string) ($plan->offer_text ?? ''))); ?>"
                            ...
                            <div class="grid gap-3 md:grid-cols-[1fr_auto] md:items-end">
                                <label class="space-y-1 text-[11px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">
                                    ...
                                    <select name="status" class="ui-input">
                                        <option value="active" <?php if($isActive): echo 'selected'; endif; ?>>Activo</option>
                                        <option value="inactive" <?php if(! $isActive): echo 'selected'; endif; ?>>Inactivo</option>
                                    </select>
                                </label>
                                <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','size' => 'sm','disabled' => ! $schemaReady]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','size' => 'sm','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(! $schemaReady)]); ?>Guardar cambios <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Promociones comerciales','subtitle' => 'Aqui solo creas promociones. Luego las aplicas donde quieras al renovar.','class' => 'sa-form-card']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Promociones comerciales','subtitle' => 'Aqui solo creas promociones. Luego las aplicas donde quieras al renovar.','class' => 'sa-form-card']); ?>
            <div class="grid gap-5 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
                <section class="sa-form-panel is-solid">
                    ...
                    <form method="POST" action="<?php echo e($schemaReady ? route('superadmin.plan-templates.promotions.store') : '#'); ?>" class="sa-form-workbench mt-4 grid gap-3">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid gap-3 md:grid-cols-[180px_minmax(0,1fr)_minmax(0,1fr)] md:items-end">
                            <label class="space-y-1 text-xs font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">
                                ...
                                <select name="duration_unit" id="promotion-duration-unit" class="ui-input">
                                    <option value="months" <?php if((string) old('duration_unit', 'months') === 'months'): echo 'selected'; endif; ?>>Meses</option>
                                    <option value="days" <?php if((string) old('duration_unit') === 'days'): echo 'selected'; endif; ?>>Dias</option>
                                </select>
                            </label>
                            <label id="promotion-duration-months-wrap" class="space-y-1 text-xs font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">
                                ...
                                <input type="number"
                                       ...
                                       class="ui-input"
                                       value="<?php echo e(old('duration_months', 1)); ?>">
                            </label>
                            <label id="promotion-duration-days-wrap" class="space-y-1 text-xs font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">
                                ...
                                <input type="number"
                                       ...
                                       class="ui-input"
                                       value="<?php echo e(old('duration_days', 5)); ?>">
                            </label>
                        </div>
                        ...
                        <div class="flex justify-end">
                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','disabled' => ! $schemaReady]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(! $schemaReady)]); ?>Crear promoción <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                ...
                <section class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <article class="sa-form-panel is-solid">
                            <div class="flex flex-wrap items-center gap-2">
                                <span class="sa-pill <?php echo e($promotionStatus ? 'is-success' : 'is-neutral'); ?>"><?php echo e($promotionStatus ? 'Activa' : 'Inactiva'); ?></span>
                                <span class="sa-pill is-info"><?php echo e($linkedBasePlan?->name ?? 'Global'); ?></span>
                            </div>

                            <h3 class="mt-4 text-lg font-black text-slate-900 dark:text-slate-50"><?php echo e($promotion->name); ?></h3>
                            <div class="mt-3 grid gap-3 md:grid-cols-3">
                                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/50">
                                    <p class="text-[11px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">Tipo</p>
                                    <p class="mt-1 font-semibold text-slate-900 dark:text-slate-100"><?php echo e($typeLabel); ?></p>
                                </div>
                                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/50">
                                    <p class="text-[11px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">Valor</p>
                                    <p class="mt-1 font-semibold text-slate-900 dark:text-slate-100"><?php echo e($valueLabel); ?></p>
                                </div>
                                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/50">
                                    <p class="text-[11px] font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">Duracion</p>
                                    <p class="mt-1 font-semibold text-slate-900 dark:text-slate-100"><?php echo e($promotionDurationLabel); ?></p>
                                </div>
                            </div>

                            <p class="mt-4 text-sm leading-6 text-slate-600 dark:text-slate-300">
                                <?php echo e(trim((string) ($promotion->description ?? '')) !== '' ? $promotion->description : 'Sin texto visible configurado.'); ?>

                            </p>

                            <div class="mt-5 ui-action-grid">
                                <form method="POST" action="<?php echo e($schemaReady ? route('superadmin.plan-templates.promotions.toggle', $promotion->id) : '#'); ?>" class="w-full">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PATCH'); ?>
                                    <input type="hidden" name="status" value="<?php echo e($promotionStatus ? 'inactive' : 'active'); ?>">
                                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','size' => 'sm','variant' => $promotionStatus ? 'muted' : 'success','class' => 'ui-action-button','disabled' => ! $schemaReady]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','size' => 'sm','variant' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($promotionStatus ? 'muted' : 'success'),'class' => 'ui-action-button','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(! $schemaReady)]); ?>
                                        <span class="ui-action-button-label"><?php echo e($promotionStatus ? 'Desactivar' : 'Activar'); ?></span>
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
...
<?php endif; ?>
                                ...
                                <form method="POST" action="<?php echo e($schemaReady ? route('superadmin.plan-templates.promotions.destroy', $promotion->id) : '#'); ?>" onsubmit="return confirm('Esta accion eliminara la promocion. Deseas continuar?');">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','size' => 'sm','variant' => 'danger','class' => 'ui-action-button','disabled' => ! $schemaReady]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','size' => 'sm','variant' => 'danger','class' => 'ui-action-button','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(! $schemaReady)]); ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Motor comercial de promociones','subtitle' => 'Organiza promociones directas y tambien ofertas mas compuestas, como mes gratis o cierres de 10 dias.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Motor comercial de promociones','subtitle' => 'Organiza promociones directas y tambien ofertas mas compuestas, como mes gratis o cierres de 10 dias.']); ?>
            ...
            <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_340px]">
                <form method="POST" action="<?php echo e($schemaReady ? route('superadmin.plan-templates.promotions.store') : '#'); ?>" class="grid gap-4">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="mt-4 grid gap-3 md:grid-cols-2">
                            ...
                            <label class="space-y-1 text-xs font-bold uppercase tracking-wide text-slate-500 dark:text-slate-300">
                                ...
                                <select name="plan_template_id" class="ui-input js-promotion-plan-select" required>
                                    ...
                                    <?php $__currentLoopData = $promotionPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(! $schemaReady)]); ?>Crear promocion base <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                ...
                <div class="space-y-4">
                    ...
                    <div class="sa-mini-card">
                        <strong><?php echo e($activePromotions); ?> promociones activas</strong>
            ...
            <div class="sa-toolbar mt-5">
                <div class="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                    ...
                    <div class="flex flex-wrap items-center gap-2 lg:justify-end">
                        <span class="sa-pill is-info" role="status" aria-live="polite">Visibles: <strong id="promotion-visible-count"><?php echo e($promotions->count()); ?></strong></span>
                ...
                <table class="ui-table min-w-[1080px]">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $promotions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            ?>
                            <tr data-promotion-row data-promotion-status="<?php echo e($isActive ? 'active' : 'inactive'); ?>" data-promotion-search="<?php echo e($promotionSearch); ?>">
                                <td>
                                    <p class="font-semibold text-slate-800 dark:text-slate-100"><?php echo e($promotion->name); ?></p>
                                    <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($promotion->description ?: '-'); ?></p>
                                    <p class="mt-2 text-xs font-semibold leading-5 text-slate-600 dark:text-slate-300"><?php echo e($commercialNarrative); ?></p>
                                </td>
                                <td class="dark:text-slate-200"><?php echo e($promotion->planTemplate?->name ?? '-'); ?></td>
                                <td class="dark:text-slate-200"><?php echo e($typeLabel); ?></td>
                                <td class="dark:text-slate-200"><?php echo e($valueLabel); ?></td>
                                <td class="dark:text-slate-200"><?php echo e($rangeLabel); ?></td>
                                <td class="dark:text-slate-200"><?php echo e($promotion->duration_months ? $promotion->duration_months.' meses' : '-'); ?></td>
                                <td>
                                    <span class="sa-pill <?php echo e($isActive ? 'is-success' : 'is-neutral'); ?>"><?php echo e($isActive ? 'Activa' : 'Inactiva'); ?></span>
                                </td>
                                <td class="min-w-[16rem]">
                                    <div class="ui-action-grid">
                                        <form method="POST" action="<?php echo e($schemaReady ? route('superadmin.plan-templates.promotions.toggle', $promotion->id) : '#'); ?>" class="w-full">
                                            ...
                                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'submit','size' => 'sm','variant' => $isActive ? 'muted' : 'success','class' => 'ui-action-button','disabled' => ! $schemaReady]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','size' => 'sm','variant' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isActive ? 'muted' : 'success'),'class' => 'ui-action-button','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(! $schemaReady)]); ?>
                                                <span class="ui-action-button-label"><?php echo e($isActive ? 'Desactivar' : 'Activar'); ?></span>
                                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
...
<?php endif; ?>
                                        ...
                                        <form method="POST" action="<?php echo e($schemaReady ? route('superadmin.plan-templates.promotions.destroy', $promotion->id) : '#'); ?>" onsubmit="return confirm('Esta accion eliminara la promocion base. Deseas continuar?');">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
...
<script>
    (function () {
        const promotionPlanCatalog = <?php echo json_encode($promotionPreviewPlans, 15, 512) ?>;
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\gymsystem\resources\views/superadmin/plans.blade.php ENDPATH**/ ?>