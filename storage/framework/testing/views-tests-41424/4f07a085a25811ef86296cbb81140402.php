<?php
    ...
    $aboutOutcomeCards = [
        ...
        ['icon' => 'access', 'title' => 'Controlar asistencia en segundos', 'text' => 'La entrada de clientes deja de ser una adivinanza y se convierte en información útil.', 'tag' => 'Ingreso ágil'],
        ...
        <div class="about-premium-hero reveal" <?php if($aboutHeroVisualImage !== ''): ?> style="--about-premium-hero-image: url('<?php echo e($aboutHeroVisualImage); ?>');" <?php endif; ?>>
            ...
            <div class="about-premium-hero-panel">
                <article class="about-premium-panel-card about-premium-panel-card--primary">
                    ...
                    <div class="about-premium-panel-pill-row" data-reveal-group data-reveal-step="70">
