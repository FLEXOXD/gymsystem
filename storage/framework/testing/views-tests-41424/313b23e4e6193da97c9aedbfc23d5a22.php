        ...
        <div class="sa-table-shell mt-4 overflow-x-auto">
            <table class="ui-table min-w-[1100px]">
                ...
                <?php $__empty_1 = true; $__currentLoopData = ($pushCampaigns ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <tr data-push-campaign-status="<?php echo e((string) ($campaign->status ?? 'queued')); ?>">
                        <td class="dark:text-slate-200"><?php echo e($campaign->created_at?->format('Y-m-d H:i') ?? '-'); ?></td>
                        <td class="font-semibold dark:text-slate-100"><?php echo e($campaign->gym?->name ?? 'Todos'); ?></td>
                        <td class="dark:text-slate-200"><?php echo e($audienceLabel); ?></td>
                        <td class="dark:text-slate-200"><?php echo e($campaign->title); ?></td>
                        <td>
                            <span class="<?php echo e($statusVariant); ?>">
                                <?php echo e($campaign->status); ?>

                            </span>
                        </td>
                        <td class="dark:text-slate-200"><?php echo e((int) ($campaign->sent_count ?? 0)); ?></td>
                        <td class="dark:text-slate-200"><?php echo e((int) ($campaign->failed_count ?? 0)); ?></td>
                        <td class="dark:text-slate-200"><?php echo e((int) ($campaign->skipped_count ?? 0)); ?></td>
                    </tr>
            ...
            <table class="ui-table min-w-[1100px]">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        ...
                        <td class="dark:text-slate-200"><?php echo e($notification->channel); ?></td>
                        <td>
