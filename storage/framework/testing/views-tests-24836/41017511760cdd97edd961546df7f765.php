...
<?php $__env->startPush('styles'); ?>
    <style>
        ...
        .client-elite-shell.client-pro-shell {
            ...
            background:
                radial-gradient(circle at top right, rgb(234 179 8 / 0.14), transparent 34%),
        ...
        .dark .client-elite-shell.client-pro-shell {
            ...
            background:
                radial-gradient(circle at top right, rgb(234 179 8 / 0.11), transparent 34%),
                radial-gradient(circle at bottom left, rgb(16 185 129 / 0.08), transparent 28%),
                linear-gradient(155deg, rgb(10 12 24 / 0.95), rgb(17 24 39 / 0.9));
        }

        .client-elite-shell.client-pro-shell::after {
            background: linear-gradient(95deg, transparent, rgb(234 179 8 / 0.05), transparent);
        }
...
<?php $__env->startSection('content'); ?>
    ...
    <div x-data="clientShowPage({
        ...
        <?php if($planControlClientDashboard): ?>
            <section class="client-control-shell">
                <div class="client-control-grid">
                    <div class="client-control-copy">
                        ...
                        <h2 class="client-control-heading"><?php echo e($planControlClientDashboard['headline'] ?? 'Ficha lista para cobrar y operar'); ?></h2>
                        <p class="client-control-summary"><?php echo e($planControlClientDashboard['summary'] ?? 'Usa esta vista para revisar estado, ultimo cobro y asistencia sin perder limpieza visual.'); ?></p>
                    </div>

                    <div class="client-control-actions">
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','variant' => 'primary','xOn:click' => ''.e(! empty($planControlClientDashboard['current_plan_id']) ? 'openRenewalModal()' : 'openMembershipModal()').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'primary','x-on:click' => ''.e(! empty($planControlClientDashboard['current_plan_id']) ? 'openRenewalModal()' : 'openMembershipModal()').'']); ?>
                            <?php echo e($planControlClientDashboard['renewal_action_label'] ?? 'Cobrar membresia'); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('reception.index', $moduleRouteParams),'variant' => 'secondary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('reception.index', $moduleRouteParams)),'variant' => 'secondary']); ?>Ir a recepcion <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('cash.index', $moduleRouteParams),'variant' => 'ghost']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('cash.index', $moduleRouteParams)),'variant' => 'ghost']); ?>Ir a caja <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php endif; ?>
                ...
                <div class="client-control-priority-grid mt-4">
                    <article class="client-control-priority" data-tone="<?php echo e($planControlClientDashboard['status_tone'] ?? 'neutral'); ?>">
                        <p class="client-control-priority-label">Estado de membresia</p>
                        <p class="client-control-priority-value"><?php echo e($planControlClientDashboard['status_value'] ?? 'Sin membresia'); ?></p>
                        <p class="client-control-priority-note"><?php echo e($planControlClientDashboard['status_note'] ?? ''); ?></p>
                    </article>

                    <article class="client-control-priority" data-tone="success">
                        <p class="client-control-priority-label">Ultimo cobro</p>
                        <p class="client-control-priority-value"><?php echo e(\App\Support\Currency::format((float) ($planControlClientDashboard['last_payment_amount'] ?? 0), $appCurrencyCode)); ?></p>
                        <p class="client-control-priority-note"><?php echo e($planControlClientDashboard['last_payment_label'] ?? 'Sin cobro registrado.'); ?></p>
                    </article>

                    <article class="client-control-priority" data-tone="<?php echo e($planControlClientDashboard['attendance_tone'] ?? 'neutral'); ?>">
                        <p class="client-control-priority-label">Ultima asistencia</p>
                        <p class="client-control-priority-value"><?php echo e($planControlClientDashboard['attendance_value'] ?? 'Sin registro'); ?></p>
                        <p class="client-control-priority-note"><?php echo e($planControlClientDashboard['attendance_note'] ?? ''); ?></p>
                    </article>
                </div>
            </section>
        <?php endif; ?>
                ...
                <div class="client-pro-grid">
                    <div class="flex flex-wrap items-start justify-between gap-3">
                        <div class="client-pro-copy">
                            ...
                            <h2 class="client-pro-heading"><?php echo e($professionalClientDashboard['headline'] ?? 'Foco comercial del cliente'); ?></h2>
                            <p class="client-pro-summary"><?php echo e($professionalClientDashboard['summary'] ?? 'Renovacion, promo y venta adicional en una sola lectura compacta.'); ?></p>
                        </div>
                    ...
                    <div class="client-pro-metrics">
                        <?php $__currentLoopData = $professionalClientMetrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="client-pro-metric" data-tone="<?php echo e($metric['tone']); ?>">
                                <p class="client-pro-metric-label"><?php echo e($metric['label']); ?></p>
                                <p class="client-pro-metric-value"><?php echo e($metric['value']); ?></p>
                                <p class="client-pro-metric-note"><?php echo e($metric['note']); ?></p>
                            </article>
                    ...
                    <div class="client-pro-insights">
                        <article class="client-pro-chip" data-tone="info">
                            ...
                            <p class="client-pro-chip-copy"><?php echo e($professionalClientDashboard['attendance_label'] ?? 'Sin asistencia registrada'); ?></p>
                        </article>
                        <?php $__currentLoopData = $professionalClientAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="client-pro-chip" data-tone="<?php echo e($alert['tone'] ?? 'info'); ?>">
                                <p class="client-pro-chip-title"><?php echo e($alert['title'] ?? 'Alerta'); ?></p>
                                <p class="client-pro-chip-copy"><?php echo e($alert['description'] ?? ''); ?></p>
                            </article>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php unset($__componentOriginala8bb031a483a05f647cb99ed3a469847); ?>
<?php endif; ?>
                        <?php elseif(! empty($canUseSalesInventory)): ?>
                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('sales.index', $moduleRouteParams),'variant' => 'secondary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('sales.index', $moduleRouteParams)),'variant' => 'secondary']); ?>Registrar venta <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php unset($__componentOriginala8bb031a483a05f647cb99ed3a469847); ?>
<?php endif; ?>
                        <?php elseif(! empty($canShowProgress) && ! empty($progressTabUrl)): ?>
                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
...
<?php endif; ?>
        ...
        <?php if($premiumClientDashboard): ?>
            <?php
                $premiumClientAlerts = collect($premiumClientDashboard['alerts'] ?? [])->values();
                $premiumClientMetrics = [
                    [
                        'label' => 'Acceso cliente',
                        'value' => $premiumClientDashboard['app_access_value'] ?? 'Pendiente',
                        'note' => $premiumClientDashboard['app_access_note'] ?? 'Todavia no tiene usuario app configurado.',
                    ...
                    [
                        'label' => 'Productos',
                        'value' => \App\Support\Currency::format((float) ($premiumClientDashboard['product_sales_revenue'] ?? 0), $appCurrencyCode),
                        'note' => (int) ($premiumClientDashboard['product_sales_count'] ?? 0).' ticket(s) | '.($premiumClientDashboard['last_product_sale_label'] ?? 'Sin ventas'),
                        'tone' => 'warning',
                    ],
                ];
            ?>
                ...
                <div class="client-pro-grid">
                    <div class="flex flex-wrap items-start justify-between gap-3">
                        <div class="client-pro-copy">
                            ...
                            <h2 class="client-pro-heading"><?php echo e($premiumClientDashboard['headline'] ?? 'Cliente listo para renovar y usar experiencia premium'); ?></h2>
                            <p class="client-pro-summary"><?php echo e($premiumClientDashboard['summary'] ?? 'Cobro, acceso app y actividad del cliente dentro de una sola cabecera premium.'); ?></p>
                        </div>
                    ...
                    <div class="client-pro-insights">
                        <article class="client-pro-chip" data-tone="info">
                            <p class="client-pro-chip-title">Asistencia</p>
                            <p class="client-pro-chip-copy"><?php echo e($premiumClientDashboard['attendance_label'] ?? 'Sin asistencia registrada'); ?></p>
                        </article>
                        <?php $__currentLoopData = $premiumClientAlerts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alert): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="client-pro-chip" data-tone="<?php echo e($alert['tone'] ?? 'info'); ?>">
                                <p class="client-pro-chip-title"><?php echo e($alert['title'] ?? 'Alerta'); ?></p>
                                <p class="client-pro-chip-copy"><?php echo e($alert['description'] ?? ''); ?></p>
                            </article>
                    ...
                    <div class="client-pro-actions">
                        <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['type' => 'button','variant' => 'primary','xOn:click' => ''.e(! empty($premiumClientDashboard['current_plan_id']) ? 'openRenewalModal()' : 'openMembershipModal()').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'primary','x-on:click' => ''.e(! empty($premiumClientDashboard['current_plan_id']) ? 'openRenewalModal()' : 'openMembershipModal()').'']); ?>
                            <?php echo e(! empty($premiumClientDashboard['current_plan_id']) ? 'Renovar mismo plan' : 'Cobrar membresia'); ?>
...
<?php unset($__componentOriginala8bb031a483a05f647cb99ed3a469847); ?>
<?php endif; ?>
                        <?php if(! empty($premiumClientDashboard['app_access_ready']) && ! empty($canManageClientAccounts) && \Illuminate\Support\Facades\Route::has('client-portal.index')): ?>
                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('client-portal.index', $moduleRouteParams),'variant' => 'secondary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('client-portal.index', $moduleRouteParams)),'variant' => 'secondary']); ?>Portal cliente <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
...
<?php unset($__componentOriginala8bb031a483a05f647cb99ed3a469847); ?>
<?php endif; ?>
                        <?php elseif(! empty($canManageClientAccounts)): ?>
                            <?php if (isset($component)) { $__componentOriginala8bb031a483a05f647cb99ed3a469847 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala8bb031a483a05f647cb99ed3a469847 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.button','data' => ['href' => route('clients.show', array_merge($clientRouteParams, ['tab' => 'app_access'])),'variant' => 'secondary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('clients.show', array_merge($clientRouteParams, ['tab' => 'app_access']))),'variant' => 'secondary']); ?>Configurar acceso app <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala8bb031a483a05f647cb99ed3a469847)): ?>
<?php $attributes = $__attributesOriginala8bb031a483a05f647cb99ed3a469847; ?>
<?php unset($__attributesOriginala8bb031a483a05f647cb99ed3a469847); ?>
