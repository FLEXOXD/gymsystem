...
@section('content')
    ...
    <div class="space-y-5">
        ...
        <x-ui.card title="Cupo de cajeros" subtitle="Limites aplicados segun el plan activo de esta sede.">
        ...
        <x-ui.card title="Cajeros" subtitle="Activa/desactiva usuarios, define permisos de caja y elimina permanentemente si hace falta.">
            <div class="overflow-x-auto">
                <table class="ui-table min-w-[1320px]">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-3 py-6 text-center text-sm text-slate-500 dark:text-slate-300">No hay cajeros registrados en esta sede.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
