<div class="grid gap-6 xl:grid-cols-12">
    <div class="space-y-6 xl:col-span-8">
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            <x-ui.card title="Ultimas asistencias" subtitle="Ultimos ingresos registrados.">
            ...
            <x-ui.card title="Ultimos pagos" subtitle="Movimientos de caja vinculados al cliente.">
